...
/**
 * @namespace
 * @exports TargetNS as Core.Agent.Admin.Znuny4CareOnCloudDynamicFieldScreen
 * @description
 *      This namespace contains the special module functions for the Dynamic Field Screen module.
 */
Core.Agent.Admin.Znuny4CareOnCloudDynamicFieldScreen = (function (TargetNS) {
    ...
    return TargetNS;
}(Core.Agent.Admin.Znuny4CareOnCloudDynamicFieldScreen || {}));

Core.Agent.Admin.Znuny4CareOnCloudDynamicFieldScreen.Init();
