...
/**
 * @namespace
 * @exports TargetNS as Core.Znuny4CareOnCloudAutoCheckbox
 * @description
 *      This namespace contains the special functions for Znuny4CareOnCloudAutoCheckbox.
 */
Core.Znuny4CareOnCloudAutoCheckbox = (function (TargetNS) {
    ...
    return TargetNS;
}(Core.Znuny4CareOnCloudAutoCheckbox || {}));
