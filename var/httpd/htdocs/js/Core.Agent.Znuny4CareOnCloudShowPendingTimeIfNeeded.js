...
/**
 * @namespace
 * @exports TargetNS as Core.Agent.Znuny4CareOnCloudShowPendingTimeIfNeeded
 * @description
 *      This namespace contains the special module functions for Znuny4CareOnCloudShowPendingTimeIfNeeded.
 */
Core.Agent.Znuny4CareOnCloudShowPendingTimeIfNeeded = (function (TargetNS) {
    var PendingStates = [];
    ...
    return TargetNS;
}(Core.Agent.Znuny4CareOnCloudShowPendingTimeIfNeeded || {}));
