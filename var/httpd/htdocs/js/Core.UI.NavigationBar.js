...
Core.UI.NavigationBar = (function (TargetNS) {
    ...
    function NavBarShrink() {
        ...
        if ($(window).width() >= 768) {
            ...
            $('#oooNavBarAvatarDescSecondary > p').each(function() {
                $(this).hide();
            });
        }
        // mobile mode
    ...
    TargetNS.Init = function() {
        ...
        $('#oooAvatar :first-child').hover(
            function() {
                $('#oooUser .oooNavBarAvatarDesc h3').addClass('Highlight');
            },
            function() {
                $('#oooUser .oooNavBarAvatarDesc h3').removeClass('Highlight');
            },
        );
        $('#oooNavBarAvatarSecondary').hover(
            function() {
                $('#oooNavBarAvatarDescSecondary > p').addClass('Highlight');
            },
            function() {
                $('#oooNavBarAvatarDescSecondary > p').removeClass('Highlight');
            }
        );
    };
