...
/**
 * @namespace Core.Agent.Admin.About
 * @memberof Core.Agent.Admin
 * @author
 * @description
 *      This namespace contains the special module functions for the Notification Event module.
 */
Core.Agent.Admin.About = (function (TargetNS) {

    /**
     * @name Init
     * @memberof Core.Agent.Admin.About
     * @function
     * @description
    ...
    TargetNS.Init = function () {
        ...
        $('.LanguageAdd').off('change.About').on('change.About', function () {
   ...
   /**
    ...
    TargetNS.AddLanguage = function(LanguageID, Language){
        ...
        // append to container
        $('.AboutLanguageContainer').append($Clone);
    ...
    TargetNS.RemoveLanguage = function (Object) {
        Object.closest('.AboutLanguage').remove();
        TargetNS.LanguageSelectionRebuild();
    };
    ...
    TargetNS.LanguageSelectionRebuild = function () {
        ...
        $Languages.each(function () {
            if (!$('.AboutLanguageContainer label#' + $(this).val() + '_Label_Subject').length) {
