...
bin/careoncloud.CheckModules.pl - a helper for checking CPAN dependencies

=head1 SYNOPSIS

    # print usage information
    bin/careoncloud.CheckModules.pl
    bin/careoncloud.CheckModules.pl --help
    bin/careoncloud.CheckModules.pl -h
    ...
    bin/careoncloud.CheckModules.pl --features

    # Print a list of all packages belonging to at least one of the listed features.
    bin/careoncloud.CheckModules.pl --flist <features>
    ...
    bin/careoncloud.CheckModules.pl --finst <features>

    # Install packages that are needed for running the test suite
    bin/careoncloud.CheckModules.pl --flist devel:test
    bin/careoncloud.CheckModules.pl --finst devel:test
    ...
    bin/careoncloud.CheckModules.pl --generate-cpanfiles
    ...
    bin/careoncloud.CheckModules.pl --plackup-cpanfile > cpanfile.plackup

    # Print a cpanfile with the required modules for Kernel/cpan-lib
    # This file is only used for sporadic updates
    bin/careoncloud.CheckModules.pl --bundled-cpanfile > Kernel/cpan-lib/cpanfile
...
my %FeatureDescription = (
    ...
    'mail:sasl'         => 'DIGEST-MD5 authentication in IMAP and SASL mechanism in SMTP connections',
    'mail:ntlm'         => 'NTLM authentication mechanism in IMAP connections',
...
my @NeededModules = (
    ...
    },
    {
        ...
        Features        => ['devel:profiling'],
        Comment         => 'plack middleware for profiling a plack app like careoncloud.psgi',
        InstTypes       => {},
    },
);
...
# and call:
#    mkdir tmp-cpan-lib
#    ./bin/careoncloud.CheckModules.pl --bundled-cpanfile > tmp-cpan-lib/cpanfile
#
END_HEADER
