...
- [ ] `SEC-01b`: katalog, case/ticket, Generic Interface, daemon ve rapor tamamlandi; cache ve search adapter'larinda zorunlu tenant policy entegrasyonu acik.
...
2. `SEC-01b`: kalan case/API/cache/search policy adapter'lari ve katalog DB constraint sertlestirmesi
