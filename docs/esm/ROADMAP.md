...
1. `AUD-01b-core`: OTOBO ticket/Generic Interface/tenant-directory/SLA mutasyonlari icin transaction/outbox audit completeness, retention/legal hold ve WORM sink
