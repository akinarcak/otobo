...
- `VERIFIED_IN_CODE`: [Ticket audit coverage inventory](security/TICKET-AUDIT-COVERAGE.md) records the covered ticket writes and the two remaining P0 core mutations. No claim of full TicketAudit coverage is made.
