...
- Kalan ticket/Chat/SLA/Generic Interface yollarında atomik audit/outbox kapsamı.
...
- Çalışma ağacı büyük ölçüde dirty durumdadır; mevcut değişiklikler korunmalı, toplu reset/checkout yapılmamalıdır.
