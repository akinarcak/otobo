...
Options:
  ...
  --compose-file PATH          Compose file (default: development/careoncloud/compose.yml).
  ...
  --env-file PATH              Environment file containing CareOnCloud_DB_ROOT_PASSWORD.
  ...
  --new-app-volume NAME        New volume (default: careoncloud-esm_careoncloud-app).
  --new-update-volume NAME     New volume (default: careoncloud-esm_careoncloud-update).
...
ComposeFile='development/careoncloud/compose.yml'
ComposeProject=''
EnvFile=''
OldAppVolume=''
OldUpdateVolume=''
NewAppVolume='careoncloud-esm_careoncloud-app'
NewUpdateVolume='careoncloud-esm_careoncloud-update'
OldDatabase='otobo'
