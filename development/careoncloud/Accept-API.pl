...
$DB->Prepare(
    SQL => "SELECT ticket_id FROM careoncloud_ticket_scope WHERE tenant_id = ? AND status = 'active' ORDER BY ticket_id ASC",
...
eval {
    ...
    my $IdempotencyKey = 'api-accept-careoncloud-demo-v1-0001';
    my $WriteHeaders = {
