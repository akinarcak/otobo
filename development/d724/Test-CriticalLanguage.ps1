...
$Journeys = @(
    @{
        ...
        Template = 'packages/D724Catalog/Kernel/Output/HTML/Templates/Standard/CustomerD724Catalog.tt'
        Locale = 'packages/D724Catalog/Kernel/Language/tr_D724Catalog.pm'
    },
    @{
        Name = 'agent-operations-center'
        Template = 'packages/D724Reporting/Kernel/Output/HTML/Templates/Standard/AgentD724Operations.tt'
        Locale = 'packages/D724Reporting/Kernel/Language/tr_D724Reporting.pm'
    }
)
