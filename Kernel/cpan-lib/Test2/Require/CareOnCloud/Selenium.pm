...
package Test2::Require::CareOnCloud::Selenium;
...
Test2::Require::CareOnCloud::Selenium - run tests only when Selenium is available

=head1 SYNOPSIS

    # to be included on top of a test script
    use Test2::Require::CareOnCloud::Selenium;
