...
package Test2::Require::CareOnCloud::OpenLDAP;
...
Test2::Require::CareOnCloud::OpenLDAP - run tests only when the host I<testing-openldap> is reachable

=head1 SYNOPSIS

    # to be included on top of a test script
    use Test2::Require::CareOnCloud::OpenLDAP;
