...
package Kernel::Output::HTML::ArticleAction::AgentTicketArticleRestore;
...
sub CheckAccess {
    ...
    #   AgentTicketArticleRestore has no module config on its own
    #   and permission is viewed as transferable from AgentTicketArticleRestore
...
sub GetConfig {
    ...
    my %MenuItem = (
        ItemType    => 'Link',
        Description => Translatable('Restore this article'),
        Name        => Translatable('Restore'),
        Class       => 'ArticleRestore',
        Link        =>
