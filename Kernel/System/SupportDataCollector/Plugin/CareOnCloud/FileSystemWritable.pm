...
package Kernel::System::SupportDataCollector::Plugin::CareOnCloud::FileSystemWritable;
...
sub Run {
    ...
    if (@ReadonlyDirectories) {
        $Self->AddResultProblem(
            ...
            Message => Translatable('The file system on your CareOnCloud ESM partition is not writable.'),
        );
    }
    else {
        $Self->AddResultOk(
