...
package Kernel::System::SupportDataCollector::Plugin::CareOnCloud::ArticleSearchIndexStatus;
...
sub GetDisplayPath {
    return Translatable('CareOnCloud ESM') . '/' . Translatable('Article Search Index Status');
}
