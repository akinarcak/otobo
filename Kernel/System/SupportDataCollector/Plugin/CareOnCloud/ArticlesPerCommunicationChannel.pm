...
package Kernel::System::SupportDataCollector::Plugin::CareOnCloud::ArticlesPerCommunicationChannel;
...
sub GetDisplayPath {
    return Translatable('CareOnCloud ESM') . '/' . Translatable('Articles Per Communication Channel');
}
