...
package Kernel::System::MigrateFromOTRS::CareOnCloudSalutationsMigrate;
...
Kernel::System::MigrateFromOTRS::CareOnCloudSalutationsMigrate - Migrate salutations table to CareOnCloud ESM.
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloud ESMSalutationsMigrate',
            SubTask   => "Migrate salutation templates to CareOnCloud ESM.",
            StartTime => $Epoch,
        },
    );
