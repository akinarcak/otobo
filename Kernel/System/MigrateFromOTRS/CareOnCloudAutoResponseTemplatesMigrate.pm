...
package Kernel::System::MigrateFromOTRS::CareOnCloudAutoResponseTemplatesMigrate;
...
Kernel::System::MigrateFromOTRS::CareOnCloudAutoResponseTemplatesMigrate - Migrate auto response table to CareOnCloud ESM.
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloudAutoResponseTemplatesMigrate',
