...
package Kernel::System::MigrateFromOTRS::CareOnCloudNotificationMigrate;
...
Kernel::System::MigrateFromOTRS::CareOnCloudNotificationMigrate - Migrate Notification table to CareOnCloud ESM.
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloud ESMNotificationMigrate',
            SubTask   => "Migrate notifications to CareOnCloud ESM.",
            StartTime => $Epoch,
        },
    );
