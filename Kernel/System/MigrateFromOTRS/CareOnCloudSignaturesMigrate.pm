...
package Kernel::System::MigrateFromOTRS::CareOnCloudSignaturesMigrate;
...
Kernel::System::MigrateFromOTRS::CareOnCloudSignaturesMigrate - Migrate signature table to CareOnCloud ESM.
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloudSignaturesMigrate',
    ...
    for my $Signature (@Signatures) {
        ...
        next SIGNATURE unless $NeedToReplace;
