...
package Kernel::System::MigrateFromOTRS::CareOnCloudMigrateWebServiceConfiguration;
...
Kernel::System::MigrateFromOTRS::CareOnCloudMigrateWebServiceConfiguration -  Migrate web service configuration (parameter change for REST/SOAP).
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloudMigrateWebServiceConfiguration',
            SubTask   => 'Prepare.',
            StartTime => $Epoch,
        },
    );
