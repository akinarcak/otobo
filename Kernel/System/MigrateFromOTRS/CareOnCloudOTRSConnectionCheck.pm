...
package Kernel::System::MigrateFromOTRS::CareOnCloudOTRSConnectionCheck;
...
Kernel::System::MigrateFromOTRS::CareOnCloudOTRSConnectionCheck - Checks required framework version for update.
...
sub _CheckOTRSConfigpm {
    ...
    if ( !-e "$OTRSConfigpmPath" ) {
        return {
            Message    => $Self->{LanguageObject}->Translate("Check if we are able to connect to OTRS home directory."),
