...
package Kernel::System::MigrateFromOTRS::CareOnCloudPostmasterFilterMigrate;
...
Kernel::System::MigrateFromOTRS::CareOnCloudPostmasterFilterMigrate - Migrate Notification table to CareOnCloud ESM.
...
sub Run {
    ...
    $CacheObject->Set(
        ...
        Key   => 'MigrationState',
        Value => {
            Task      => 'CareOnCloud ESMPostmasterFilterMigrate',
            SubTask   => "Migrate postmaster filter to CareOnCloud ESM.",
            StartTime => $Epoch,
        },
    );
