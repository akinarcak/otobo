...
package Kernel::System::MigrateFromOTRS::CareOnCloudCopyFilesFromOTRS;
...
Kernel::System::MigrateFromOTRS::CareOnCloudCopyFilesFromOTRS - Copy and migrate OTRS files to CareOnCloud ESM server
...
sub Run {
    ...
    my @FileList = $Self->CopyFileListfromOTRSToCareOnCloud();
