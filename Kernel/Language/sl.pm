...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Attribute' => '',
        'FQDN' => '',
        'CareOnCloud ESM Version' => 'Verzija CareOnCloud ESM',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Novi uporabnik baze z omejenimi pravicami bo ustvarjen za ta CareOnCloud ESM sistem',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'Fully qualified domain name of your system.' => 'FQDN - ime servera uključujući puno ime domena, npr. "careoncloud-server.example.org"',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Da biste mogli koristiti CareOnCloud ESM morate unijeti slijedeću liniju u Vašu komandnu liniju (Terminal/Shell) kao "root".',
        'Restart your webserver' => 'Ponovno zaženite Vaš WEB Server.',
        'After doing so your CareOnCloud ESM is up and running.' => 'Po tem bo vaš CareOnCloud ESM pripravljen na delo.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM testna stran',
        'Unlock' => 'Sprosti',
        'Welcome %s %s' => '',
        'Counter' => 'Števec',
        ...
        'Install CareOnCloud ESM' => 'Namesti CareOnCloud ESM',
        'Intro' => 'Uvod',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM novice',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Vaše sporočilo E-pošte s številko zahtevka "<CareOnCloud_TICKET>" je združena z zahtevkom "<CareOnCloud_MERGE_TO_TICKET>"!',
        'Your external tools' => '',
        'Your last tickets' => '',
