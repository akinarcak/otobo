...
sub Data {
    ...
    $Self->{Completeness}        = 0.256219616814412;
    ...
    $Self->{Translation} = {
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Овој CareOnCloud ESM позадински повикувачки модул ќе биде повикан за да подготви податоци за испраќање на одалечен систем, и да ги испроцесира податочен одговор.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Податоците од повикувач на CareOnCloud ESM ќе бидат обработени со оваа мапирање, за да го трансформира во вид на податоци на системот за далечинско очекува.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Податоците за одговор ќе бидат обработени со оваа мапирање, за да го трансформира во вид на податоци на повикувач на очекувања на CareOnCloud ESM.',
        ...
        'This CareOnCloud ESM operation backend module will be called internally to process the request, generating data for the response.' =>
            'Овој CareOnCloud ESM позадински операциски модул ќе биде повикан интерно за да го испроцесира барањето , генерирајки податоци за одговорот.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data CareOnCloud ESM expects.' =>
            'Побараните податоци ќе бидат процесирани со оваа мапирање , за да се трансформираат во вид на податочна форма која CareOnCloud ESM ја очекува.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that CareOnCloud ESM will process.' =>
            'Тука може да наведете максималната големина (во бајти) на REST пораки кои CareOnCloud ESM ќе ги обработува.',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem' => 'п.р. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA' => 'на пример: /opt/careoncloud/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'Тука може да наведете максималната големина (во бајти) на SOAP пораките кои CareOnCloud ESM ќе ги процесира.',
        'Encoding' => 'Кодирање',
        ...
        'In provider mode, CareOnCloud ESM offers web services which are used by remote systems.' =>
            'Во режимот на провајдерот, CareOnCloud ESM нуди веб услуги кои се користат од страна на далечински системи.',
        'In requester mode, CareOnCloud ESM uses web services of remote systems.' =>
            'Во побарувачки мод, CareOnCloud ESM користи веб сервиси од далечински системи.',
        ...
        'Import/Export Management' => 'Внеси/Изнеси Менаџмент',
        'Add template' => 'Додади шаблон',
        'Create a template to import and export object information.' => 'Креирај шаблон за внесени и изнесени објект информации',
        ...
        'Number' => 'Број',
        'Format' => 'Формат',
        'Start Import' => 'Започни внесување',
        'Start Export' => 'Започни излез',
        'Delete this template' => '',
        'Step 1 of 5 - Edit common information' => '',
        'Name is required!' => 'Потребно е име!',
        'Object is required!' => 'Потребен е објект!',
        'Format is required!' => 'Потребен е формат!',
        'Next' => 'Следен',
        'Step 2 of 5 - Edit object information' => '',
        'Back' => 'Назад',
        'Step 3 of 5 - Edit format information' => '',
        'is required!' => 'Задолжително е!',
        'Step 4 of 5 - Edit mapping information' => '',
        'No map elements found.' => 'Нема мапирани елементи.',
        'Up' => 'Горе',
        'Down' => 'Доле',
        'Add Mapping Element' => 'Додади Мапирани Елементи',
        'Step 5 of 5 - Edit search information' => '',
        'Template Name' => '',
        'Restrict export per search' => 'Ограничи излезни барања',
        'Finish' => 'Крај',
        'Import information' => 'Влезни Информации',
        'Source File' => 'Изворен податок',
        'Import summary for %s' => '',
        'Records' => 'Снимки',
        'Success' => 'Успешно',
        'Failed' => 'Не успеа',
        'Duplicate names' => 'Дупликат име ',
        'Last processed line number of import file' => 'Последно обработени број на линии на внесени податоци',
        'Ok' => 'Ok',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'Овој пакет е потврден од CareOnCloud ESMverify (tm)',
        ...
        'CareOnCloud ID Login' => 'CareOnCloud ID Најава',
        'System registration is a service of CareOnCloud ESM Team, which provides a lot of advantages!' =>
            '',
        'Read more' => 'Прочитај повеќе',
        'You need to log in with your CareOnCloud ID to register your system.' =>
            'Морате да бидете логирани со вашиот CareOnCloud ID за да го регистрирате вашиот систем.',
        ...
        'Can I use CareOnCloud ESM without being registered?' => 'Дали може да користам не-регистриран CareOnCloud ESM?',
        'System registration is optional.' => 'Регистрација на системот е опционална.',
        'You can download and use CareOnCloud ESM without being registered.' => 'Можете да го превземете и користите CareOnCloud ESM без притоа тој да е регистриран.',
        ...
        'Fully Qualified Domain Name (FQDN), CareOnCloud ESM version, Database, Operating System and Perl version.' =>
            'Комплетно Квалификувано Име на Домеин (FQDN), CareOnCloud ESM верзија, Датабаза, Оперативен Систем и Perl верзија.',
        ...
        'How often does my CareOnCloud ESM system send updates?' => 'Колку често CareOnCloud ESM системот испраќа надградба?',
        ...
        'You need to log in with your CareOnCloud ID to deregister your system.' =>
            'Морате да бидете најавени со вашиот CareOnCloud ID за да го дерегистрирате вашиот систем.',
        'CareOnCloud ID' => 'CareOnCloud ID',
        'You don\'t have a CareOnCloud ID yet?' => 'Сеуште немате CareOnCloud ID?',
        ...
        'After doing so your CareOnCloud ESM is up and running.' => '',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM како давател',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'OТRS како барател',
        'Invokers' => '',
        ...
        'Column Separator' => 'Разделувач на колони',
        'Tabulator (TAB)' => 'Таб (TAB)',
        'Semicolon (;)' => 'Точка-запирка (;)',
        'Colon (:)' => 'Две Точки (:)',
        'Dot (.)' => 'Точка (.)',
        'Comma (,)' => '',
        'Charset' => 'Множество знаци',
        'Include Column Headers' => 'Вклучи заглавие на колона',
        'Column' => 'Колона',
        ...
        'CareOnCloud ESM Disk Partition' => 'CareOnCloud ESM диск партиција',
        ...
        'The file system on your CareOnCloud ESM partition is not writable.' => 'На датотечниот систем на вашиот CareOnCloud ESM партиција не може да се запишува.',
...
' => '',
        ...
        'Import and export object information.' => 'Внеси и изнеси објект информации',
        'Import appointments screen.' => '',
        'Import/Export' => 'Внеси/Изнеси',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'ОТRS Вести',
