...
sub Data {
    ...
    $Self->{Completeness}        = 0.233342865313126;
    ...
    $Self->{Translation} = {
        ...
        'Import/Export Management' => 'Import/Export Správa',
        'Add template' => '',
        ...
        'Number' => 'Číslo',
        'Format' => '',
        'Start Import' => 'Zahájit Import',
        'Start Export' => 'Zahájit Export',
        ...
        'Restrict export per search' => 'Omezit Export vyhledáváním',
        'Finish' => 'Ukončit',
        'Import information' => 'Informace o Importu',
        'Source File' => 'Zdrojový Soubor',
        'Import summary for %s' => '',
        'Records' => 'Záznamů',
        'Success' => 'Úspěšně',
        'Failed' => 'Neúspěšně',
        'Duplicate names' => 'Duplicitní jména',
        ...
        'Attribute' => 'Atribut',
        'FQDN' => '',
        'CareOnCloud ESM Version' => 'Verze CareOnCloud ESM',
        ...
        'Your CareOnCloud ESM Team' => 'Váš CareOnCloud ESM tým',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Abyste mohli používat CareOnCloud ESM, musíte zadat následující řádek do Vašeho příkazového řádku (Terminal/Shell) jako root.',
        'Restart your webserver' => 'Restartujte Váš webserver',
        'After doing so your CareOnCloud ESM is up and running.' => 'Po dokončení následujících operací je Váš CareOnCloud ESM spuštěn a běžící.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Testovací CareOnCloud ESM stránka',
        'Unlock' => 'Odemknout',
        'Welcome %s %s' => '',
        'Counter' => 'Počítadlo',
        ...
        'ACLs could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Z důvodu neznámé chyby ACL nemohly být naimportovány, pro více informací prosím zkontrolujte logy CareOnCloud ESM',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM jako poskytovatel',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM jako žadatel',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Instalovat CareOnCloud ESM',
        'Intro' => 'Úvod',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'CareOnCloud ESM plánovač není spuštěn.',
        ...
        'CareOnCloud ESM Disk Partition' => 'CareOnCloud ESM diskový oddíl',
        ...
        'The file system on your CareOnCloud ESM partition is not writable.' => 'Na souborový systém na vaší CareOnCloud ESM particii není možné zapisovat.',
...
' => '',
        ...
        'Filter for debugging ACLs. Note: More ticket attributes can be added in the format <CareOnCloud_TICKET_Attribute> e.g. <CareOnCloud_TICKET_Priority>.' =>
            'Filtr pro ladění ACL. Poznámka: Více atributů tiketů můžete přidat ve formátu <CareOnCloud_TICKET_Attribute> např. <CareOnCloud_TICKET_Priority>.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Novinky CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Váš email s číslem tiketu "<CareOnCloud_TICKET>" je svázán s "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
