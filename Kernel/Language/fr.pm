...
sub Data {
    ...
    $Self->{Completeness}        = 0.39519588218473;
    ...
    $Self->{Translation} = {
        ...
        'It is sometimes recommended to send this data to the CareOnCloud ESM team in order to get better support.' =>
            'Il est recommandé d\'envoyer de temps en temps cette donnée à l\'équipe CareOnCloud ESM dans le but d\'avoir un meilleur support.',
        ...
        'This will allow the system to send additional support data information to the CareOnCloud ESM team.' =>
            'Cela autorisera le système à envoyer des informations supplémentaires à l\'équipe CareOnCloud ESM.',
        ...
        'To enable data sending, please register your system with the CareOnCloud ESM team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Pour permettre l\'envoi des données, enregistrez votre système à l\'équipe CareOnCloud ESM or mettez à jour les informations d\'enregistrement de votre système (activez l\'option "envoi de données au support".)',
        ...
        'System registration is a service of CareOnCloud ESM team, which provides a lot of advantages!' =>
            'L\'enregistrement du système est un service de l\'équipe CareOnCloud ESM, qui donne beaucoup d\'avantages !',
        'Please note that the use of CareOnCloud ESM cloud services requires the system to be registered.' =>
            'L\'utilisation des services de cloud CareOnCloud ESM nécessitent d\'enregistrer le système.',
        'Register this system' => 'Enregistrer ce système',
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Le module de CareOnCloud ESM comprenant l\'arrière-plan du demandeur traitera les données envoyées au système distant ainsi que celles composant la réponse.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Les données du demandeur de CareOnCloud ESM seront traitées lors du mappage; elles seront converties pour le système distant.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Les données composant les réponses seront traitées lors du mappage; elles seront converties pour le demandeur de CareOnCloud ESM.',
        ...
        'This CareOnCloud ESM operation backend module will be called internally to process the request, generating data for the response.' =>
            'Ce module de l\'arrière-plan des opérations de CareOnCloud ESM sera appelé dans le programme afin de traiter la demande, générant ainsi des donnée permettant de répondre.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data CareOnCloud ESM expects.' =>
            'La réquisition de données sera traitée par mappage afin de la transformer en données lisibles par CareOnCloud ESM.',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem' => 'par ex. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA' => 'par ex. /opt/careoncloud/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'indiquez ici le poids maximal (en octets) des messages du protocole SOAP que CareOnCloud ESM traitera.',
        'Encoding' => 'codage',
        ...
        'In provider mode, CareOnCloud ESM offers web services which are used by remote systems.' =>
            'En mode « fournisseur », CareOnCloud ESM offre des services Web aux systèmes à distance.',
        'In requester mode, CareOnCloud ESM uses web services of remote systems.' =>
            'En mode « demandeur », CareOnCloud ESM utilise les services Web des systèmes à distance.',
        ...
        'To be able to use PGP in CareOnCloud ESM, you have to enable it first.' =>
            'Pour utiliser PGP dans CareOnCloud ESM, vous devez l\'activer en premier.',
        ...
        'Please note that your installed CareOnCloud ESM version is %s.' => 'Veuillez noter que la version CareOnCloud ESM installée est la %s',
        ...
        'This package can only be installed on CareOnCloud ESM version %s or newer.' =>
            '',
        'Why should I keep CareOnCloud ESM up to date?' => 'Pourquoi dois-je garder CareOnCloud ESM à jour ?',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'Ce paquet est vérifié par CareOnCloud ESMverify (tm)',
        ...
        'Please note that you can\'t register your system if CareOnCloud ESM Daemon is not running correctly!' =>
            'Veuillez noter que vous ne pouvez pas enregistrer votre système si le démon CareOnCloud ESM ne fonctionne pas correctement !',
        'Instructions' => 'Instructions',
        'System Deregistration not Possible' => '',
        'CareOnCloud ID Login' => 'Identifiant CareOnCloud ID',
        'System registration is a service of CareOnCloud ESM Team, which provides a lot of advantages!' =>
            '',
        'Read more' => 'Lire plus',
        'You need to log in with your CareOnCloud ID to register your system.' =>
            'Vous devez vous identifier avec votre identifiant CareOnCloud ID pour enregistrer votre système.',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use CareOnCloud ESM without being registered?' => 'Puis-je utiliser CareOnCloud ESM sans être enregistré ?',
        'System registration is optional.' => '',
        'You can download and use CareOnCloud ESM without being registered.' => 'Vous pouvez télécharger et utiliser CareOnCloud ESM sans être enregistré.',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my CareOnCloud ESM system send updates?' => '',
        ...
        'You need to log in with your CareOnCloud ID to deregister your system.' =>
            '',
        'CareOnCloud ID' => '',
        'You don\'t have a CareOnCloud ID yet?' => '',
        ...
        'Attribute' => '',
        'FQDN' => '',
        'CareOnCloud ESM Version' => 'Version CareOnCloud ESM',
        ...
        'To be able to use SMIME in CareOnCloud ESM, you have to enable it first.' =>
            'Pour utiliser SMIME dans CareOnCloud ESM, vous devez l\'activer en premier.',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => 'Le saviez-vous ? Vous pouvez aider à traduire CareOnCloud ESM sur %s',
        ...
        'Create a new database for CareOnCloud ESM' => 'Créer une nouvelle base de données pour CareOnCloud ESM',
        'Use an existing database for CareOnCloud ESM' => 'Utiliser une base de données existante pour CareOnCloud ESM',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Un nouvel utilisateur de la base de données sera créé avec des droits limités pour ce système CareOnCloud ESM.',
        ...
        'Your CareOnCloud ESM Team' => 'Votre Équipe CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Pour pouvoir utiliser CareOnCloud ESM, vous devez entrer les commandes suivantes dans votre terminal en tant que root.',
        'Restart your webserver' => 'Redémarrer votre serveur web',
        'After doing so your CareOnCloud ESM is up and running.' => 'Après avoir fait ceci votre CareOnCloud ESM est en service',
        ...
        'Sorry, but this feature of CareOnCloud ESM is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Désolé mais cette fonctionnalité d\'CareOnCloud ESM n\'est actuellement pas disponible pour les appareils mobiles. Si vous le souhaitez, vous pouvez toutefois basculer en mode version pour ordinateur ou utiliser votre ordinateur de bureau.',
        ...
        'Process Information' => 'Traitement de l\'information',
        'Dialog' => 'Discussion',
        ...
        'This is the default public interface of CareOnCloud ESM! There was no action parameter given.' =>
            'Voici l\'interface publique par défaut d\'CareOnCloud ESM! Aucun paramètre n\'a été enregistré. ',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Page de test d\'CareOnCloud ESM',
        ...
        'Update and extend your system with software packages.' => 'Mettre à jour et améliorer CareOnCloud ESM via des paquets.',
        ...
        'ACLs could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Ensemble de ACL ne peut pas être importé dû à un erreur inconnu, veuillez vérifier le journal de CareOnCloud ESM pour plus d\'information.',
        ...
        'Notifications could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Ensemble de notification ne peut pas être importé dû a un erreur, veuillez vérifier les journaux de CareOnCloud ESM pour plus d\'information.',
        ...
        'The imported file has not valid YAML content! Please check CareOnCloud ESM log for details' =>
            'Le contenu du fichier importé n\'est pas en format "YAML" valide. Veuillez vérifier le journal de CareOnCloud ESM pour des détails',
        'Web service "%s" deleted!' => 'Le service web "%s" a été supprimé !',
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM, fournisseur',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM, demandeur',
        'Invokers' => '',
        ...
        'Package not verified by the CareOnCloud ESM Team!' => 'Le paquet n\'a pas été vérifié par l\'équipe CareOnCloud ESM !',
        ...
        'End forwarded message' => 'Fin du message transféré',
        ...
        'If you want to re-run the MigrateFromOTRS Tool, disable the SecureMode in the SysConfig.' =>
            '',
        'OTRS to CareOnCloud ESM migration' => 'La migration de OTRS vers CareOnCloud ESM',
        ...
        'Can\'t connect to CareOnCloud ESM News server!' => 'Impossible de se connecter au serveur des nouvelles CareOnCloud ESM !',
        'Can\'t get CareOnCloud ESM News from server!' => 'Impossible d\'obtenir les nouvelles CareOnCloud ESM à partir du serveur !',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'La tâche de fond d\'CareOnCloud ESM n\'est pas lancée',
        ...
        'CareOnCloud ESM Disk Partition' => 'Partition disque CareOnCloud ESM',
        ...
        'Information about the CareOnCloud ESM Daemon' => 'Information à propos de la tâche de fond d\'CareOnCloud ESM',
...
' => '',
        ...
        'Merged Ticket <CareOnCloud_TICKET> to <CareOnCloud_MERGE_TO_TICKET>.' => 'Fusionner le ticket <CareOnCloud_TICKET> avec <CareOnCloud_MERGE_TO_TICKET>.',
        'Message of the day' => '',
        'Minute' => '',
        ...
        'New process ticket' => '',
        'News about CareOnCloud ESM.' => 'Nouveautés à propos d\'CareOnCloud ESM.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Nouvelles d\'CareOnCloud ESM',
        ...
        'Select your personal time zone. All times will be displayed relative to this time zone.' =>
            'Sélectionnez votre fuseau horaire personnel. L\'horaire du système CareOnCloud ESM sera relatif à cette heure.',
        'Select your preferred layout for the software.' => 'Sélectionnez votre skin préféré pour le système.',
        'Select your preferred theme for CareOnCloud ESM.' => 'Sélectionnez votre thème préféré pour CareOnCloud ESM.',
        ...
        'This setting is deprecated. Set CareOnCloud ESMTimeZone instead.' => 'Ce paramètre est déprécié. Utilisez CareOnCloud ESMTimeZone.',
        ...
        'Toggles display of CareOnCloud ESM FeatureAddons list in PackageManager.' =>
            'Déclenche l\'affichage de la liste des modules complémentaires d\'CareOnCloud ESM dans le gestionnaire de paquets.',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is bounced to "<CareOnCloud_BOUNCE_TO>". Contact this address for further information.' =>
            'Votre email avec le ticket numéro "<CareOnCloud_TICKET>" est renvoyé à "<CareOnCloud_BOUNCE_TO>". Contactez cette adresse pour plus d\'informations.',
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Votre e-mail avec le numéro de ticket "<CareOnCloud_TICKET>" a été fusionné avec le ticket numéro "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
