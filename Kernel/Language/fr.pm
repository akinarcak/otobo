...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This package is verified by CareOnCloud Verify (tm)' => 'Ce paquet est vérifié par CareOnCloud Verify (tm)',
...
' => '',
        ...
        'This setting is deprecated. Set CareOnCloudTimeZone instead.' => 'Ce paramètre est déprécié. Utilisez CareOnCloudTimeZone.',
