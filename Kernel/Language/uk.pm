...
sub Data {
    ...
    $Self->{Completeness}        = 0.407063197026022;
    ...
    $Self->{Translation} = {
        ...
        'It is sometimes recommended to send this data to the CareOnCloud ESM team in order to get better support.' =>
            'Іноді рекомендується надсилати ці дані команді CareOnCloud ESM, щоб отримати кращу підтримку.',
        ...
        'This will allow the system to send additional support data information to the CareOnCloud ESM team.' =>
            'Це дозволить системі надсилати додаткові дані підтримки команді CareOnCloud ESM.',
        'Update' => 'Оновити',
        ...
        'To enable data sending, please register your system with the CareOnCloud ESM team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'Щоб увімкнути надсилання даних, зареєструйте свою систему в команді CareOnCloud ESM або оновіть реєстраційну інформацію системи (переконайтеся, що активована опція «надсилати дані підтримки»).',
        ...
        'System registration is a service of CareOnCloud ESM team, which provides a lot of advantages!' =>
            'Реєстрація в системі - послуга команди CareOnCloud ESM, яка надає масу переваг!',
        'Please note that the use of CareOnCloud ESM cloud services requires the system to be registered.' =>
            'Будь ласка, зауважте, що використання хмарних сервісів CareOnCloud ESM вимагає, щоб систему було зареєстровано.',
        'Register this system' => 'Зареєструвати цю систему.',
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Цей внутрішній модуль CareOnCloud ESM активатора буде викликаний щоб підготувати дані для відправки до віддаленої системи та обробляти дані її відповіді.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Дані з активатора CareOnCloud ESM будуть оброблені цим відображенням, щоб перетворити їх до того вигляду даних, який очікує віддалена система.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Дані відповіді будуть оброблені цим відображенням так, щоб перетворити їх до того виду, що очікує активатор CareOnCloud ESM.',
        ...
        'Asynchronous event triggers are handled by the CareOnCloud ESM Scheduler Daemon in background (recommended).' =>
            'Асинхронні тригери подій будуть оброблятись Службою Планувальника CareOnCloud ESM у фоновому режимі (рекомендовано).',
        ...
        'This CareOnCloud ESM operation backend module will be called internally to process the request, generating data for the response.' =>
            'Цей внутрішній операційний модуль CareOnCloud ESM буде викликаний внутрішньо щоб обробити запит та згенерувати дані для відповіді.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data CareOnCloud ESM expects.' =>
            'Дані запиту будуть оброблені цим відображенням, щоб перетворити його до виду даних, що очікує CareOnCloud ESM.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that CareOnCloud ESM will process.' =>
            'Тут ви можете визначити максимальний розмір (в байтах) REST повідомлення, що буде оброблено CareOnCloud ESM.',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem' => 'наприклад /opt/careoncloud/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA' => 'наприклад /opt/careoncloud/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'Тут ви можете визначити максимальний обсяг (в байтах) SOAP повідомлення, що буде обробляти CareOnCloud ESM.',
        'Encoding' => 'Кодування',
        ...
        'In provider mode, CareOnCloud ESM offers web services which are used by remote systems.' =>
            'В режимі постачальника, CareOnCloud ESM пропонує веб-служби, які використовуються віддаленими системами.',
        'In requester mode, CareOnCloud ESM uses web services of remote systems.' =>
            'В режимі запитувача, CareOnCloud ESM використовую веб-служби віддалених систем.',
        ...
        'You can use CareOnCloud ESM-tags like <CareOnCloud_TICKET_DynamicField_...> to insert values from the current ticket.' =>
            'Ви можете використовувати CareOnCloud ESM-теги, такі як  <CareOnCloud_TICKET_DynamicField_...>  щоб вставити значення з поточного квитка.',
        ...
        'To be able to use PGP in CareOnCloud ESM, you have to enable it first.' =>
            'Щоб мати змогу використовувати PGP в CareOnCloud ESM ви повинні спочатку увімкнути його.',
        ...
        'Go to the CareOnCloud ESM customer portal' => 'Перейти до порталу клієнтів CareOnCloud ESM',
        'package information' => 'інформація про пакет',
        'Package installation requires a patch level update of CareOnCloud ESM.' =>
            'Установка пакунку потребує оновлення рівня виправлень CareOnCloud ESM.',
        'Package update requires a patch level update of CareOnCloud ESM.' => 'Оновлення пакунку потребує оновлення рівня оновлень CareOnCloud ESM.',
        'Please note that your installed CareOnCloud ESM version is %s.' => 'Зверніть увагу, що версія встановленого CareOnCloud ESM %s.',
        'To install this package, you need to update CareOnCloud ESM to version %s or newer.' =>
            'Щоб встановити цей пакунок, ви маєте оновити CareOnCloud ESM до версії %s або новіше.',
        'This package can only be installed on CareOnCloud ESM version %s or older.' =>
            'Цей пакунок можна встановити на CareOnCloud ESM версії %s або старше.',
        'This package can only be installed on CareOnCloud ESM version %s or newer.' =>
            'Цей пакунок можна встановити на CareOnCloud ESM версії %s або новіше.',
        'Why should I keep CareOnCloud ESM up to date?' => 'Чому я маю тримати CareOnCloud ESM в актуальному стані?',
        ...
        'You will receive updates for all other relevant CareOnCloud ESM issues.' =>
            'Ви будете отримувати оновлення для всіх інших питань стосовно CareOnCloud ESM.',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'Цей пакунок перевірений CareOnCloud ESMverify (tm)',
        'Uninstall' => 'Вилучити',
        ...
        'Please note that you can\'t register your system if CareOnCloud ESM Daemon is not running correctly!' =>
            'Будь ласка зверніть увагу, що ви не можете зареєструвати вашу систему якщо фонова програма CareOnCloud ESM не працює правильно!',
        'Instructions' => 'Інструкції',
        'System Deregistration not Possible' => '',
        'CareOnCloud ID Login' => 'CareOnCloud ID Ім\'я',
        'System registration is a service of CareOnCloud ESM Team, which provides a lot of advantages!' =>
            '',
        'Read more' => 'Докладніше',
        'You need to log in with your CareOnCloud ID to register your system.' =>
            'Ви маєте увійти з вашим ім\'ям CareOnCloud ID, щоб зареєструвати вашу систему.',
        ...
        'Can I use CareOnCloud ESM without being registered?' => 'Чи можу я використовувати CareOnCloud ESM без реєстрації?',
        'System registration is optional.' => 'Реєстрація системи не є обов\'язковою.',
        'You can download and use CareOnCloud ESM without being registered.' => 'Ви можете завантажити та використовувати CareOnCloud ESM без реєстрації.',
        ...
        'Fully Qualified Domain Name (FQDN), CareOnCloud ESM version, Database, Operating System and Perl version.' =>
            'Повне доменне ім\'я (FQDN), версія CareOnCloud ESM, База даних, Операційна система та версія Perl.',
        ...
        'How often does my CareOnCloud ESM system send updates?' => 'Як часто моя CareOnCloud ESM система відправляє оновлення?',
        ...
        'You need to log in with your CareOnCloud ID to deregister your system.' =>
            'Ви маєте увійти під своїм CareOnCloud ID щоб скасувати реєстрацію вашої системи.',
        'CareOnCloud ID' => 'CareOnCloud ID',
        'You don\'t have a CareOnCloud ID yet?' => 'У вас ще немає CareOnCloud ID?',
        'Sign up now' => 'Увійти',
        ...
        'Attribute' => 'Атрибут',
        'FQDN' => 'FQDN',
        'CareOnCloud ESM Version' => 'Версій CareOnCloud ESM',
        ...
        'To be able to use SMIME in CareOnCloud ESM, you have to enable it first.' =>
            'Для того, щоб мати можливість використовувати SMIME в CareOnCloud ESM, ви повинні спочатку його дозволити.',
        ...
        'The CareOnCloud ESM Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'CareOnCloud ESM демон це фоновий процес, що виконує асинхронні завдання, на кшталт ввімкнення підвищення квитка, надсилання пошти тощо.',
        'A running CareOnCloud ESM Daemon is mandatory for correct system operation.' =>
            'Демон CareOnCloud ESM, що працює, є обов\'язковою умовою для коректної роботи системи.',
        'Starting the CareOnCloud ESM Daemon' => 'Запуск CareOnCloud ESM демона.',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the CareOnCloud ESM Daemon is running and start it if needed.' =>
            'Переконайтесь в тому, що файл \'%s\' існує (без розширення .dist). Це заплановане завдання буде перевіряти кожні 5 хвилин чи запущений демон CareOnCloud ESM та запустить його за потреби.',
        'Execute \'%s start\' to make sure the cron jobs of the \'careoncloud\' user are active.' =>
            'Виконайте \'%s start\' щоб впевнитись в тому, заплановані завдання користувача \'careoncloud\' активні.',
        'After 5 minutes, check that the CareOnCloud ESM Daemon is running in the system (\'bin/careoncloud.Daemon.pl status\').' =>
            'Після 5 хвилин, переконайтеся, що CareOnCloud ESM демон працює в системі (\'bin/careoncloud.Daemon.pl status\').',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => 'Ви можете допомогти перекласти OTRD в %s.',
        ...
        'Create a new database for CareOnCloud ESM' => 'Створити нову базу даних CareOnCloud ESM',
        'Use an existing database for CareOnCloud ESM' => 'Використати наявну базу даних CareOnCloud ESM',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Для цієї системи CareOnCloud ESM буде створено нового користувача бази даних з обмеженими правами.',
        ...
        'Your CareOnCloud ESM Team' => 'Команда розроблювачів CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Щоб використовувати CareOnCloud ESM, виконайте в командному рядку під правами root наступну команду:',
        'Restart your webserver' => ' Запустите знову ваш веб-сервер',
        'After doing so your CareOnCloud ESM is up and running.' => 'Після цих дій система вже запущена.',
        ...
        'Sorry, but this feature of CareOnCloud ESM is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Вибачте, але ця функція CareOnCloud ESM наразі не доступна для мобільних пристроїв. Якщо ви бажаєте скористатися нею, ви можете увімкнути стільничний режим або використати стаціонарний комп\'ютер.',
        ...
        'This is the default public interface of CareOnCloud ESM! There was no action parameter given.' =>
            'Це типовий публічний інтерфейс CareOnCloud ESM! Не задано жодного дійового параметра.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Тестова сторінка CareOnCloud ESM',
        'Unlock' => 'Розблокувати',
        ...
        'ACLs could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Списки АСL не можуть бути імпортовані через невідому помилку, будь ласка, перевірте журнал CareOnCloud ESM для отримання додаткової інформації.',
        ...
        'Notifications could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Через невідому помилку Сповіщення не вдалося імпортувати, будь ласка, перегляньте CareOnCloud ESM-журнали для отримання додаткової інформації.',
        ...
        'The imported file has not valid YAML content! Please check CareOnCloud ESM log for details' =>
            'Файл, що імпортується, не має правильного YAML вмісту! Будь ласка, перегляньте CareOnCloud ESM журнал для отримання детальної інформації.',
        'Web service "%s" deleted!' => 'Веб-службу "%s" вилучено!',
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM як провайдер',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM як подавач запиту',
        'Invokers' => '',
        ...
        'Can\'t connect to CareOnCloud ESM Feature Add-on list server!' => 'Неможливо встановити зв\'язок із сервером списку Додаткових функцій CareOnCloud ESM!',
        'Can\'t get CareOnCloud ESM Feature Add-on list from server!' => 'Неможливо отримати список Додаткових функцій CareOnCloud ESM з серверу!',
        'Can\'t get CareOnCloud ESM Feature Add-on from server!' => 'Неможливо отримати Додаткові функції CareOnCloud ESM з серверу!',
        ...
        'Install CareOnCloud ESM' => 'Встановити CareOnCloud ESM',
        'Intro' => 'Вступ',
        ...
        'Install CareOnCloud ESM - Error' => 'Встановлення CareOnCloud ESM - Помилка',
        ...
        'Can\'t connect to CareOnCloud ESM News server!' => 'Не можу з\'єднатись з сервером новин CareOnCloud ESM!',
        'Can\'t get CareOnCloud ESM News from server!' => 'Неможливо отримати новини CareOnCloud ESM від сервера!',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'CareOnCloud ESM Daemon не працює.',
        ...
        'Column Separator' => 'Роздiльник стовпчикiв',
        'Tabulator (TAB)' => 'Табулятор (TAB)',
        ...
        'CareOnCloud ESM Disk Partition' => '',
        ...
        'The file system on your CareOnCloud ESM partition is not writable.' => '',
        ...
        'Information about the CareOnCloud ESM Daemon' => 'Інформація про демон CareOnCloud ESM',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Новини CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Ваш email з номером заявки «<CareOnCloud_TICKET>» об\'єднаний з "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
