...
הקבצים צריכים להיות בפורמט yml. אשר ייצאו דרך מודול  ACL editor.',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use CareOnCloud ESM without being registered?' => 'האם אפשר להשתמש ב- CareOnCloud ESM בלי להירשם',
        ...
        'The description and system type you specify help you to identify and manage the details of your registered systems.' =>
            '',
        'How often does my CareOnCloud ESM system send updates?' => 'כל כמה זמן נשלחים עדכונים למערכת CareOnCloud ESM?',
        ...
        'Attribute' => 'מאפיין',
        'FQDN' => 'FQDN',
        'CareOnCloud ESM Version' => 'גרסת CareOnCloud ESM',
        ...
        'After doing so your CareOnCloud ESM is up and running.' => 'לאחר שמערכת CareOnCloud ESM תותקן.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'עמוד בדיקה CareOnCloud ESM',
        'Unlock' => 'שחרר נעילה',
        'Welcome %s %s' => '',
        'Counter' => 'מונה',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM כמספק',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM כמבקש',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'התקנת CareOnCloud ESM',
        'Intro' => 'מבוא',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'חדשות CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'הדוא"ל שלכם עם פניה מספר "<CareOnCloud_TICKET>" מוזגה עם פניה "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
