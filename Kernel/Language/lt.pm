...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This will allow the system to send additional support data information to the CareOnCloud ESM team.' =>
            'Tai leis sistemai siųsti papildomą palaikymo duomenų informaciją CareOnCloud ESM komandai.',
        'Update' => 'Atnaujinti',
        ...
        'System registration is a service of CareOnCloud ESM team, which provides a lot of advantages!' =>
            'Sistemos registracija yra CareOnCloud ESM komandos paslauga, suteikianti daug privalumų!',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Šiai CareOnCloud ESM sistemai bus sukurtas naujas, apribotas teises turintis, duomenų bazės naudotojas.',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'Your CareOnCloud ESM Team' => 'Jūsų CareOnCloud ESM komanda',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Norėdami naudoti CareOnCloud ESM turite root naudotojo teisėmis, komandinėje eilutėje (terminale), įvesti šią komandą.',
        'Restart your webserver' => 'Perkraukite savo web serverį',
        'After doing so your CareOnCloud ESM is up and running.' => 'Atlikus šiuos veiksmus bus paleista CareOnCloud ESM sistema.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM Bandomasis puslapis',
        'Unlock' => 'Atrakinti',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitliukas',
        ...
        'Install CareOnCloud ESM' => 'Įdiegti CareOnCloud ESM',
        'Intro' => '',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM Naujienos',
        ...
        'Shows existing parent/child queue lists in the system in the form of a tree or a list.' =>
            '',
        'Shows information on how to start CareOnCloud ESM Daemon' => 'Rodoma informacija, kaip paleisti „CareOnCloud ESM Daemon“',
        ...
        'This module is part of the admin area of CareOnCloud ESM.' => 'Šis modulis yra CareOnCloud ESM administratoriaus srities dalis.',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is bounced to "<CareOnCloud_BOUNCE_TO>". Contact this address for further information.' =>
            'Jūsų el. pašto adresas su kreipinio numeriu „<CareOnCloud_TICKET>“ atmetamas į „<CareOnCloud_BOUNCE_TO>“. Norėdami gauti daugiau informacijos, susisiekite šiuo adresu.',
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Jūsų el. laiškas trikties numeriu "<CareOnCloud_TICKET>" yra sujungtas su "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
