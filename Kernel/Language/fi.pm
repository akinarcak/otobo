...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Your CareOnCloud ESM Team' => 'CareOnCloud ESM Tiimi',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Voidaksesi käyttää CareOnCloud ESM-järjestelmää tulee sinun kirjoittaa seuraava komento root oikeuksilla komentokehotteessa.',
        'Restart your webserver' => 'Käynnistä web-palvelin uudestaan',
        'After doing so your CareOnCloud ESM is up and running.' => 'Tämän jälkeen CareOnCloud ESM järjestelmä on käytettävissä.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM - Testisivu',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM antaa tietoja',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM pyytää tietoja',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Asenna CareOnCloud ESM',
        'Intro' => 'Intro',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM uutiset',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Sähköpostisi tikettinumerolla "<CareOnCloud_TICKET>" on liitetty tikettiin "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
