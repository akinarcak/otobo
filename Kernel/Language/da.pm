...
sub Data {
    ...
    $Self->{Completeness}        = 0.348441521303975;
    ...
    $Self->{Translation} = {
        ...
        'It is sometimes recommended to send this data to the CareOnCloud ESM team in order to get better support.' =>
            'Det er en gang imellem anbefalesværdigt at sende disse data til CareOnCloud ESM-teamet, for at få bedre support.',
        ...
        'This will allow the system to send additional support data information to the CareOnCloud ESM team.' =>
            'Denne indstillinger tillader systemet at sende yderligere supportdata til CareOnCloud ESM-teamet.',
        'Update' => 'Opdater',
        ...
        'To enable data sending, please register your system with the CareOnCloud ESM team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'For at aktivere afsendelse af data, skal systemet registreres hos CareOnCloud ESM-teamet. Eller du kan opdatere system registrerings informationen (aktiver indstillingen \'send support data\'.)',
        ...
        'System registration is a service of CareOnCloud ESM team, which provides a lot of advantages!' =>
            'System registrering er en service fra CareOnCloud ESM-teamet, som giver dig mange fordele!',
        'Please note that the use of CareOnCloud ESM cloud services requires the system to be registered.' =>
            'Bemærk: for at benytte CareOnCloud ESM sky-tjenester skal systemet være registreret.',
        'Register this system' => 'Registrer dette system',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that CareOnCloud ESM will process.' =>
            'Her kan du angive den maksimale længde (i bytes) af REST-beskeder, som CareOnCloud ESM vil behandle.',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'Her kan du angive den maksimale størrelse (i bytes) på SOAP beskeder, som CareOnCloud ESM vil behandle.',
        'Encoding' => 'Kodning',
        ...
        'Import/Export Management' => 'Import/Ekport styring',
        ...
        'Restrict export per search' => 'Begræns ekport pr. søgning',
        'Finish' => 'Færdig',
        'Import information' => 'Import information',
        'Source File' => 'Kilde fil',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'Denne pakke er verificeret af CareOnCloud ESMverify (tm)',
        ...
        'Please note that you can\'t register your system if CareOnCloud ESM Daemon is not running correctly!' =>
            'Bemærk at du ikke kan registrere dit system hvis ikke CareOnCloud ESM tjenesten fungerer korrekt!',
        ...
        'You need to log in with your CareOnCloud ID to register your system.' =>
            'Du skal logge ind med dit CareOnCloud ID for at registrere dit system',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use CareOnCloud ESM without being registered?' => 'Kan jeg bruge CareOnCloud ESM uden at registrere?',
        'System registration is optional.' => 'Registrering er valgfrit.',
        'You can download and use CareOnCloud ESM without being registered.' => 'Du kan downloade og bruge CareOnCloud ESM uden at registrere.',
        ...
        'Fully Qualified Domain Name (FQDN), CareOnCloud ESM version, Database, Operating System and Perl version.' =>
            'Fully Qualified Domain Name (FQDN), CareOnCloud ESM-version, Database, Operativsystem og Perl-version.',
        ...
        'How often does my CareOnCloud ESM system send updates?' => 'Hvor ofte sender mit CareOnCloud ESM-system opdateringer?',
        ...
        'You need to log in with your CareOnCloud ID to deregister your system.' =>
            'Du skal logge ind med dit CareOnCloud ID for at afregistrere dit system.',
        'CareOnCloud ID' => 'CareOnCloud ID',
        'You don\'t have a CareOnCloud ID yet?' => 'Har du ikke et CareOnCloud ID endnu?',
        ...
        'The CareOnCloud ESM Daemon is a daemon process that performs asynchronous tasks, e.g. ticket escalation triggering, email sending, etc.' =>
            'CareOnCloud ESM tjenesten er en tjeneste der udfører asynkrone opgaver, f.eks. sags eskalering, afsendelse af email, osv.',
        'A running CareOnCloud ESM Daemon is mandatory for correct system operation.' =>
            'En kørende CareOnCloud ESM tjeneste er påkrævet for korrekt system operation.',
        'Starting the CareOnCloud ESM Daemon' => 'Starter CareOnCloud ESM tjeneste',
        'Make sure that the file \'%s\' exists (without .dist extension). This cron job will check every 5 minutes if the CareOnCloud ESM Daemon is running and start it if needed.' =>
            'Kontroller at filen \'%s\' eksisterer (uden .dist filendelsen). Dette cron job  checker hvert 5. minut om CareOnCloud ESM tjenesten kører og starter den om nødvendigt.',
        'Execute \'%s start\' to make sure the cron jobs of the \'careoncloud\' user are active.' =>
            'Kør \'%s start\' for at sikre at \'careoncloud\' brugerens cron job er aktive.',
        'After 5 minutes, check that the CareOnCloud ESM Daemon is running in the system (\'bin/careoncloud.Daemon.pl status\').' =>
            'Check at CareOnCloud ESM tjenesten kører efter 5 minutter (\'bin/careoncloud.Daemon.pl status\').',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => 'Vidste du det? Du kan hjælpe med at oversætte CareOnCloud ESM på %s.',
        ...
        'Create a new database for CareOnCloud ESM' => 'Opret ny database til CareOnCloud ESM',
        'Use an existing database for CareOnCloud ESM' => 'Brug en eksisterende database til CareOnCloud ESM',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'En ny database-bruger med begrænsede rettigheder vil blive oprettet til dette CareOnCloud ESM-system.',
        ...
        'Your CareOnCloud ESM Team' => 'Dit CareOnCloud ESM Team',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'For at kunne anvende CareOnCloud ESM, er du nødt til at indtaste følgende linje i din kommandolinje (Terminal/Shell) som root.',
        'Restart your webserver' => 'Genstart webserveren',
        'After doing so your CareOnCloud ESM is up and running.' => 'Når det er gjort, er din CareOnCloud ESM sat i gang og fungerer.',
        ...
        'Sorry, but this feature of CareOnCloud ESM is currently not available for mobile devices. If you\'d like to use it, you can either switch to desktop mode or use your regular desktop device.' =>
            'Beklager, men denne funktion i CareOnCloud ESM er ikke tilgængelig for mobile enheder. Hvis du gerne vil bruge den, kan du enten skifte til desktop-visning eller bruge din almindelige desktop-pc.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM prøveside',
        'Unlock' => 'Frigiv',
        ...
        'Notifications could not be Imported due to a unknown error, please check CareOnCloud ESM logs for more information' =>
            'Beskeder kunne ikke importeres grundet en ukendt fejl. Tjek CareOnCloud ESM-loggen for mere information.',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM som provider',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM som requester',
        'Invokers' => '',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'CareOnCloud ESM-dæmonen kører ikke.',
        ...
        'CareOnCloud ESM Disk Partition' => 'CareOnCloud ESM Disk Partition',
        ...
        'The file system on your CareOnCloud ESM partition is not writable.' => 'Filsystemet på din CareOnCloud ESM-partition er ikke skrivbart.',
        ...
        'CareOnCloud ESM requires apache to be run with the \'prefork\' MPM model.' =>
            'CareOnCloud ESM kræver, at apache kører med MPM-modellen \'prefork\'.',
        ...
        'Information about the CareOnCloud ESM Daemon' => 'Information om CareOnCloud ESM tjenesten',
...
' => '',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use CareOnCloud ESM. Specify the group, who may access the system.' =>
            'Hvis "LDAP" er valgt for Customer::Authmodule kan du bestemme om en bruger må logge ind ved at gøre dem til medlem af en possixGroup, f.eks. brugeren skal være medlem af gruppe xyz for at benytte CareOnCloud ESM. Angiv gruppen der skal have adgang til systemet.',
        ...
        'Merged Ticket <CareOnCloud_TICKET> to <CareOnCloud_MERGE_TO_TICKET>.' => 'Samlet sag <CareOnCloud_TICKET> med <CareOnCloud_MERGE_TO_TICKET>.',
        'Message of the day' => '',
        'Minute' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM-nyheder',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is bounced to "<CareOnCloud_BOUNCE_TO>". Contact this address for further information.' =>
            'Din e-mail med sagsnummer "<CareOnCloud_TICKET>" er overgivet til "<CareOnCloud_BOUNCE_TO>". Kontakt denne adresse for yderligere information.',
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Din sag nummer "<CareOnCloud_TICKET>" er blevet samlet med sag nummer "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
