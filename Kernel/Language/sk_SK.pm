...
sub Data {
    ...
    $Self->{Completeness}        = 0.147841006577066;
    ...
    $Self->{Translation} = {
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => 'Vedeli ste že aj Vy možete pomôcť s prekladaním CareOnCloud ESM na %s.',
        ...
        'Your CareOnCloud ESM Team' => 'Váš CareOnCloud ESM tím',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Aby ste mohli pouzivat CareOnCloud ESM =>  musite zadat nasledovne: do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'Restart your webserver' => 'dat "nasledovne") do Vasho prikazoveho riadku (terminal/shell) =>  pricom musite byt prihlaseny ako root:',
        'After doing so your CareOnCloud ESM is up and running.' => 'Ak to urobíte =>  Váš CareOnCloud ESM je spustený.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM test stránka',
        'Unlock' => 'Odomknúť',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM ako provider',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM ako žiadateľ',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Inštalácia CareOnCloud ESM',
        'Intro' => 'Úvod',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'CareOnCloud ESM démon nebeží.',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM novinky',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Váš e-mail na tikete číslo "<CareOnCloud_TICKET>" bol zlúčený do "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
