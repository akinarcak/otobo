...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Attribute' => '',
        'FQDN' => '',
        'CareOnCloud ESM Version' => 'CareOnCloud ESM versija',
        ...
        'Your CareOnCloud ESM Team' => 'Jūsu CareOnCloud ESM komanda',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Lai varētu izmantot CareOnCloud ESM, sekojošā komanda jāizpilda terminālī/čaulā.',
        'Restart your webserver' => 'Pārstartējiet tīmekļa serveri (webserver).',
        'After doing so your CareOnCloud ESM is up and running.' => 'Pēc tam CareOnCloud ESM būs darba kārtībā un palaists.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM problēmu pieteikumu sistēmas testa lapa',
        'Unlock' => 'Atslēgt',
        'Welcome %s %s' => '',
        'Counter' => 'Skaitītājs',
        ...
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM kā pieprasītājs',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Instalējiet CareOnCloud ESM',
        'Intro' => '',
        ...
        'CareOnCloud ESM Disk Partition' => 'CareOnCloud ESM diska nodalījums',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM jaunumi',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Jūsu e-pasts ar pieteikuma numuru "<CareOnCloud_TICKET>" ir apvienots ar pieteikumu nr. "<CareOnCloud_MERGE_TO_TICKET>"!',
        'Your external tools' => '',
        'Your last tickets' => '',
