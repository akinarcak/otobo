...
sub Data {
    ...
    $Self->{Completeness}        = 0.119245067200458;
...
επεξεργαστείτε τα πιστοποιητικά και ιδιωτικά κλειδιά στο αρχείο συστήματος.',
        ...
        'Your CareOnCloud ESM Team' => 'Η ομάδα CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Για να μπορεσετε να χρησιμοπιήσετε το CareOnCloud ESM πρέπει να είσάγετε την παρακάτω γραμμή στο Terminal command line ώς χρήστης root.',
        'Restart your webserver' => 'Κανετε εποανεκίνηση του webserver.',
        'After doing so your CareOnCloud ESM is up and running.' => 'Μετά απο αυτή την ενέργεια το CareOnCloud ESM θα ενεργοποιηθεί.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM δοκιμαστική σελίδα',
        'Unlock' => 'Άνοιγμα',
        'Welcome %s %s' => '',
        'Counter' => 'Μετρητής',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM ως προμηθευτής',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM ως αιτούντας',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Εγκατασταση CareOnCloud ESM',
        'Intro' => 'Εισαγωγή',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'Ο διεργασία παρασκηνίου του CareOnCloud ESM δεν εκτελείται.',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Νέα του CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Το μήνυμά σας με αριθμό δελτίου "<CareOnCloud_TICKET>" συγχωνεύτηκε με το δελτίο <CareOnCloud_MERGE_TO_TICKET>" !',
        'Your external tools' => '',
        'Your last tickets' => '',
