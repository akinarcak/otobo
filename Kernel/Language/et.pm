...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => 'Tõlkele saate kaasa aidata %s veebilehel.',
        ...
        'Install Type' => '',
        'Create a new database for CareOnCloud ESM' => 'Loo CareOnCloud ESMile uus andmebaas',
        'Use an existing database for CareOnCloud ESM' => 'Kasuta olemasolevat andmebaasi',
        ...
        'Your CareOnCloud ESM Team' => 'CareOnCloud ESM meeskond',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'CareOnCloud ESM kasutamiseks peate järgneva käsu sisestama süsteemi root-kasutajana.',
        'Restart your webserver' => 'Taaskäivita veebiserver.',
        'After doing so your CareOnCloud ESM is up and running.' => 'Peale seda CareOnCloud ESM töötab.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM testileht',
        'Unlock' => 'Eemalda lukk',
        'Welcome %s %s' => '',
        'Counter' => 'Loendur',
        ...
        'Install CareOnCloud ESM' => 'Paigalda CareOnCloud ESM',
        'Intro' => 'Sissejuhatus',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM uudised',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Teie kiri intsidendinumbriga "<CareOnCloud_TICKET>" ühendati intsidendiga "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
