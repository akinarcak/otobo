...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Your CareOnCloud ESM Team' => 'CareOnCloud ESM Takımınız',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'CareOnCloud ESM\'yi kullanabilmek için komut satırında (konsol/kabuk/terminal) root kullanıcısı olarak şu satırı girmelisiniz.',
        'Restart your webserver' => 'Web sunucunuzu yeniden başlatın.',
        'After doing so your CareOnCloud ESM is up and running.' => 'Bunu yaptıktan sonra CareOnCloud ESM çalışıyor olacak.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM Test Sayfası',
        'Unlock' => 'Kilidi Aç',
        'Welcome %s %s' => '',
        'Counter' => 'Sayaç',
        ...
        'Install CareOnCloud ESM' => 'CareOnCloud ESM\'yi kur',
        'Intro' => 'Tanıtım',
...
' => '',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM Haberleri',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            '"<CareOnCloud_TICKET>" bilet numaralı e-postanız "<CareOnCloud_MERGE_TO_TICKET>" ile birleştirildi.',
        'Your external tools' => '',
        'Your last tickets' => '',
