...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Vai ser criado um novo utilizador de base de dados com permissões limitadas para o CareOnCloud ESM',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'Your CareOnCloud ESM Team' => 'A equipa CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Para usar o CareOnCloud ESM tem de executar o seguinte comando na consola, (Terminal/Shell) como root.',
        'Restart your webserver' => 'Reinicie o servidor Web',
        'After doing so your CareOnCloud ESM is up and running.' => 'Depois de o fazer, o CareOnCloud ESM estará funcional.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Página de Teste do CareOnCloud ESM',
        'Unlock' => 'Desbloquear',
        'Welcome %s %s' => '',
        'Counter' => 'Contador',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM como prestador',
        ...
        'Can\'t connect to CareOnCloud ESM News server!' => 'Sem ligação ao servidor de Notícias!',
        'Can\'t get CareOnCloud ESM News from server!' => 'Impossível obter Notícias do servidor!',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'O Daemon CareOnCloud ESM não está em execução.',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the CareOnCloud ESM log file. A logfile for every month will be created.' =>
            'Adiciona um sufixo com o ano e mês atual ao ficheiro de log do CareOnCloud ESM. Vai ser criado um ficheiro mensal.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Notícias CareOnCloud ESM',
...
Devemos voltar a estar online dentro de momentos.',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'O ticket com o número  "<CareOnCloud_TICKET>" foi fundido com o ticket "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
