...
sub Data {
    ...
    $Self->{Completeness}        = 0.180154418072634;
    ...
    $Self->{Translation} = {
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Aquest mòdul del motor de l\'invocador de CareOnCloud ESM es dirà per preparar les dades per ser enviats al sistema remot, i per processar les seves dades de resposta.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Les dades de l\'invocador de CareOnCloud ESM seran processats ​​per aquesta assignació, per transformar-la en el tipus de dades que el sistema remot espera.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Les dades de resposta seran processats per aquesta assignació, per transformar-los en el tipus de dades que l\'invocador de CareOnCloud ESM espera.',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Un nou usuari de base de dades amb drets limitats serà creat per a aquest sistema CareOnCloud ESM.',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'Your CareOnCloud ESM Team' => 'El seu equip CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Per a poder utilitzar CareOnCloud ESM ha d\'escriure la següent linea de comandos (Terminal/Shell) com root',
        'Restart your webserver' => 'Reiniciï el seu servidor web',
        'After doing so your CareOnCloud ESM is up and running.' => 'Després de fer això el seu CareOnCloud ESM estarà actiu i executant-se',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Pàgina de prova de CareOnCloud ESM ',
        'Unlock' => 'Desbloquejar',
        'Welcome %s %s' => '',
        'Counter' => 'Comptador',
        ...
        'Install CareOnCloud ESM' => 'Instal·lar CareOnCloud ESM',
        'Intro' => 'Intro',
...
' => '',
        ...
        'Adds a suffix with the actual year and month to the CareOnCloud ESM log file. A logfile for every month will be created.' =>
            'Afegeix un sufix amb l\'any actual i el mes en el fitxer de registre de CareOnCloud ESM. Es crearà un arxiu per cada mes.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Novetats de CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'El seu correu amb nombre de tiquet "<CareOnCloud_TICKET>" es va unir a "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
