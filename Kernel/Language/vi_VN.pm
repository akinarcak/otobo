...
sub Data {
    ...
    $Self->{Completeness}        = 0.132256219616814;
    ...
    $Self->{Translation} = {
        ...
        'Add template' => '',
        'Create a template to import and export object information.' => 'Tạo một mẫu để nhập và xuất thông tin đối tượng.',
        ...
        'Number' => 'Số',
        'Format' => 'Định dạng',
        'Start Import' => 'Bắt đầu nhập vào',
        'Start Export' => 'Bắt đầu xuất ra',
        'Delete this template' => '',
        'Step 1 of 5 - Edit common information' => '',
        'Name is required!' => 'Yêu cầu phải có tên!',
        'Object is required!' => 'Yêu cầu phải có đối tượng!',
        'Format is required!' => 'Yêu cầu phải có định dạng!',
        'Next' => 'Tiếp',
        ...
        'No map elements found.' => 'Không tìm thấy đối tượng map.',
        'Up' => 'Trên',
        'Down' => 'Dưới',
        'Add Mapping Element' => 'Thêm đối tượng mapping',
        'Step 5 of 5 - Edit search information' => '',
        'Template Name' => '',
        'Restrict export per search' => 'Giới hạn dữ liệu xuất mỗi lần tìm kiếm',
        'Finish' => 'Kết thúc',
        'Import information' => 'Thông tin nhập vào',
        'Source File' => 'Tệp nguồn',
        'Import summary for %s' => '',
        'Records' => 'Bản ghi',
        'Success' => 'Thành công',
        'Failed' => 'Lỗi',
        'Duplicate names' => 'Trùng tên',
        'Last processed line number of import file' => 'Dòng cuối cùng được xử lý trong tệp nhập vào',
        'Ok' => 'Đồng ý',
        ...
        'Your CareOnCloud ESM Team' => 'Đội CareOnCloud ESM của bạn',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Để có thể sử dụng CareOnCloud ESM bạn phải nhập dòng sau vào dòng lệnh của bạn (Terminal/Shell) làm gốc.',
        'Restart your webserver' => 'Khởi động lại máy chủ web.',
        'After doing so your CareOnCloud ESM is up and running.' => 'Sau khi thực hiện CareOnCloud ESM của bạn đã hoạt động.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Trang test CareOnCloud ESM',
        'Unlock' => 'Mở khóa',
        'Welcome %s %s' => '',
        'Counter' => 'Bộ đếm',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM là nhà cung cấp ',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM như yêu cầu',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Cài đặt CareOnCloud ESM',
        'Intro' => 'Giới thiệu',
        ...
        'Column Separator' => 'Phân cách cột',
        'Tabulator (TAB)' => 'Bộ lập bảng (TAB)',
        'Semicolon (;)' => 'Dấu chấm phẩy (;)',
        'Colon (:)' => 'Dấu hai chấm (:)',
        'Dot (.)' => 'Dấu chấm (.)',
        'Comma (,)' => '',
        'Charset' => 'Bộ mã ký tự',
        'Include Column Headers' => 'Gồm tiêu đề cột',
        'Column' => 'Cột',
        ...
        'CareOnCloud ESM' => 'Open Technology Real Services',
...
' => '',
        ...
        'Import and export object information.' => 'Thông tin nhập và xuất đối tượng.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Tin tức CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'E-mail của bạn với số thẻ "<CareOnCloud_TICKET>" được trộn thành "<CareOnCloud_MERGE_TO_TICKET>"!',
        'Your external tools' => '',
        'Your last tickets' => '',
