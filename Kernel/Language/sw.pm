...
sub Data {
    ...
    $Self->{Completeness}        = 0.394623963397198;
    ...
    $Self->{Translation} = {
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Moduli ya mazingira ya nyuma ya kichochezi cha CareOnCloud ESM itaitwa kuandaa data kutumwa katika mfumo wa mbali, na kushughulikia data zake za majibu.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Data kutoka kwa kichochezi cha CareOnCloud ESM zitashughulikiwa na kuunganishwa huku, kubadilisha kuwa data ambayo mfumo wa mbali inaitarajia.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Data za majibu zitashughulikiwa na kuunganishwa kwa ramani, kuibadilisha kuwa data ambayo kichochezi cha CareOnCloud ESM kinaitarajia. ',
        ...
        'This CareOnCloud ESM operation backend module will be called internally to process the request, generating data for the response.' =>
            'Moduli ya mazingira ya nyuma ya uendeshaji ya CareOnCloud ESM yataitwa ndani kushughulikia maombi, kutengeneza data kwa ajili ya majibu.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data CareOnCloud ESM expects.' =>
            'Data za majibu zitashughulikiwa na muunganisho huu, kuibadilisha kuifanya kuwa data inayotarajiwa na CareOnCloud ESM.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that CareOnCloud ESM will process.' =>
            'Hapa unaweza kubainisha ukubwa wa upeo wa juu (katika baiti) wa jumbe zilizopumzika ambazo CareOnCloud ESM itazishughulikia.',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA/ca.pem' => 'mfano /opt/careoncloud/var/certificates/SOAP/CA/ca.pem',
        ...
        'e.g. /opt/careoncloud/var/certificates/SOAP/CA' => 'Mfano /opt/careoncloud/var/certificates/SOAP/CA',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'Hapa unaweza kubainisha ukubwa wa upeo wa juu (katika baiti) wa jumbe za SOAP ambazo CareOnCloud ESM itazishughulikia.',
        'Encoding' => 'Usimbaji',
        ...
        'In provider mode, CareOnCloud ESM offers web services which are used by remote systems.' =>
            'Katika hali tumizi ya mtoaji, CareOnCloud ESM inatoa huduma za tovuti ambazo mifumo ya mbali.',
        'In requester mode, CareOnCloud ESM uses web services of remote systems.' =>
            'Katika hali timizi ya muombaji, CareOnCloud ESM inatumia huduma za tovuti kwa ajili ya mifumo ya mbali.',
        'Network transport' => 'Usafirishaji wa mtandao',
        ...
        'Import/Export Management' => 'Usimamizi wa kuleta/Hamisha',
        'Add template' => 'Ongeza kielezo',
        'Create a template to import and export object information.' => 'Tengeneza kiolezo kuleta na kuhamisha taarifa za kipengee',
        ...
        'Number' => 'Namba',
        'Format' => 'Mpangilio',
        'Start Import' => 'Anza kuleta',
        'Start Export' => 'Anza kuhamisha',
        'Delete this template' => '',
        'Step 1 of 5 - Edit common information' => '',
        'Name is required!' => 'Jina linahitajika!',
        'Object is required!' => 'Kipengee kinahitajika!',
        'Format is required!' => 'Umbizo unahitajika',
        'Next' => 'Baadae',
        ...
        'No map elements found.' => 'Hakuna elementi zilizopatikana',
        'Up' => 'Juu',
        'Down' => 'Chini',
        'Add Mapping Element' => 'Ongeza elementi za kuweka ramani',
        'Step 5 of 5 - Edit search information' => '',
        'Template Name' => 'Jina la kielezo',
        'Restrict export per search' => 'Zuia uhamishaji kwa kila utafutaji',
        'Finish' => 'Maliza',
        'Import information' => 'Leta taarifa',
        'Source File' => 'Faili la chanzo',
        'Import summary for %s' => '',
        'Records' => 'Kumbukumbu',
        'Success' => 'Mafanikio',
        'Failed' => 'Shindwa',
        'Duplicate names' => 'Jina limejirudia:',
        'Last processed line number of import file' => 'Namba ya mstari unaokatika mchakato wa mwisho wa faili lililoletwa',
        'Ok' => 'Sawa',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'Kifurushi hiki kimethibitishwa na CareOnCloud ESMthibitisha (tm)',
        'Uninstall' => 'Sakinusha',
        ...
        'CareOnCloud ID Login' => 'CareOnCloud ESM- ingia na kitambulidho',
        'System registration is a service of CareOnCloud ESM Team, which provides a lot of advantages!' =>
            '',
        'Read more' => 'Soma zaidi',
        'You need to log in with your CareOnCloud ID to register your system.' =>
            'Unahitaji kuingia na kitambulisho chako cha CareOnCloud ESM kusajili mfumo wako.',
        ...
        'Can I use CareOnCloud ESM without being registered?' => 'Je ninawezakutumia CareOnCloud ESM bila kujisajili?',
        'System registration is optional.' => 'Usajili wa mfumo ni mzuri.',
        'You can download and use CareOnCloud ESM without being registered.' => 'Unaweza kupakua na kutumia CareOnCloud ESM bila kusajiliwa.',
        ...
        'Fully Qualified Domain Name (FQDN), CareOnCloud ESM version, Database, Operating System and Perl version.' =>
            'Jina ka Kikoa lilifuzu Kamili (FQDN), Toleo la CareOnCloud ESM, Hifadhi data, Mfumo endeshi na Toleo la Perl.',
        ...
        'How often does my CareOnCloud ESM system send updates?' => 'Ni kila baada ya muda gani mfumo wangu wa CareOnCloud ESM unatuma ushasishwaji?',
        ...
        'You need to log in with your CareOnCloud ID to deregister your system.' =>
            'Unahitaji kuingia na kitambulisho chako cha CareOnCloud ESM kutoa usajili katika mfumo wako.',
        'CareOnCloud ID' => 'Kitambulisho cha CareOnCloud ESM',
        'You don\'t have a CareOnCloud ID yet?' => 'Hauna kitambulisho cha CareOnCloud ESM bado?',
        ...
        'Attribute' => 'Sifa',
        'FQDN' => 'FQDN',
        'CareOnCloud ESM Version' => 'Toleo la CareOnCloud ESM',
        ...
        'A running CareOnCloud ESM Daemon is mandatory for correct system operation.' =>
            '',
        'Starting the CareOnCloud ESM Daemon' => '',
        ...
        'This setting can currently not be saved' => '',
        'Save this setting' => '',
        'Did you know? You can help translating CareOnCloud ESM at %s.' => '',
        ...
        'Create a new database for CareOnCloud ESM' => 'Tengeneza hifadhi data mpya kwa ajili ya CareOnCloud ESM',
        'Use an existing database for CareOnCloud ESM' => 'Tumia hifadhi data iliyopo kwa ajili ya CareOnCloud ESM',
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Mtumiaji mpya wa hifadhi data wenye ruhusa kidogo watangenezwa katika mfumo huu wa CareOnCloud ESM.',
        ...
        'Your CareOnCloud ESM Team' => 'Timu yako ya CareOnCloud ESM',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Kuweza kutumia CareOnCloud ESM ingiza mistari ifuatayo katika tungo amri yako kama mzizi.(Terminal/Shell) ',
        'Restart your webserver' => 'Washa upya seva ya tovuti',
        'After doing so your CareOnCloud ESM is up and running.' => 'Baada ya kufanya hivyo CareOnCloud ESM  itafanya kazi.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Ukurasa wa majaribio wa CareOnCloud ESM',
        'Unlock' => 'fungua',
        'Welcome %s %s' => '',
        'Counter' => 'Kiesabuji',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM kama mtoaji',
        'Operations' => 'Operesheni',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM kama  muombaji',
        'Invokers' => '',
        ...
        'Install CareOnCloud ESM' => 'Sakinisha CareOnCloud ESM',
        'Intro' => 'Utangulizi',
        ...
        'CareOnCloud ESM Daemon is not running.' => '',
        ...
        'Column Separator' => 'Kitenganishi safu wima',
        'Tabulator (TAB)' => 'Tabo (TAB)',
        'Semicolon (;)' => 'Alama ya nukta mkato (;)',
        'Colon (:)' => 'Colon (:)',
        'Dot (.)' => 'Nukta (.)',
        'Comma (,)' => '',
        'Charset' => 'Seti ya herufi',
        'Include Column Headers' => 'Ambatisha vichwa vya habari vya safuwima',
        'Column' => 'Safuwima',
        ...
        'CareOnCloud ESM Disk Partition' => 'Kitenga diski cha CareOnCloud ESM',
        ...
        'The file system on your CareOnCloud ESM partition is not writable.' => 'Mfumo wa file katika kitenga chako cha CareOnCloud ESM  hakiandikiki.',
...
"Mwaka wa kuanza wa muda wa kutengeneza tiketi=2010; Mwezi wa kuanza wa muda wa kutengeneza tiketi=10; Siku ya kuanza ya muda wa kutengeneza tiketi=4; Mwaka wa kuacha wa muda wa kutengeneza tiketi =2010; Mwezi wa kuacha wa muda wa kutengeneza tiketi = 11; Siku ya kuacha ya muda wa kutengeneza tiketi=3; ".',
        ...
        'Define a filter for html output to add links behind a defined string. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the CareOnCloud ESM image path will be used. The second possiblity is to insert the link to the image.' =>
            'Inafafanua kichujio cha matokeo ya html ili kuongeza viunganishi nyuma ya tungo zilizo fafanuliwa. Sura ya elemnti hii inaruhusu maingizo ya aina mbili. Kwanza jinala sura (mf. faq.png). Kwa kesi hii sura ya njia ya CareOnCloud ESM itatumika. Njia ya pili ni kuingiza kiungo cha hiyo sura.',
        ...
        'Defines a filter for html output to add links behind CVE numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the CareOnCloud ESM image path will be used. The second possiblity is to insert the link to the image.' =>
            'Inafafanua kichujio cha matokeo ya html ili kuongeza viungo nyuma ya namba za CVE. Sura ya elemnti hii inaruhusu maingizo ya aina mbili. Kwanza jinala sura (mf. faq.png). Kwa kesi hii sura ya njia ya CareOnCloud ESM itatumika. Njia ya pili ni kuingiza kiungo cha hiyo sura.',
        'Defines a filter for html output to add links behind MSBulletin numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the CareOnCloud ESM image path will be used. The second possiblity is to insert the link to the image.' =>
            'Inafafanua kichujio cha matokeo ya html ili kuongeza viunganishi nyuma ya namba za MSBulletin. Sura ya elemnti hii inaruhusu maingizo ya aina mbili. Kwanza jinala sura (mf. faq.png). Kwa kesi hii sura ya njia ya CareOnCloud ESM itatumika. Njia ya pili ni kuingiza kiungo cha hiyo sura.',
        ...
        'Defines a filter for html output to add links behind bugtraq numbers. The element Image allows two input kinds. At once the name of an image (e.g. faq.png). In this case the CareOnCloud ESM image path will be used. The second possiblity is to insert the link to the image.' =>
            'Inafafanua kichujio cha matokeo ya html ili kuongeza viunganishi nyuma ya namba za bugtraq. Sura ya elemnti hii inaruhusu maingizo ya aina mbili. Kwanza jinala sura (mf. faq.png). Kwa kesi hii sura ya njia ya CareOnCloud ESM itatumika. Njia ya pili ni kuingiza kiungo cha hiyo sura.',
        ...
        'Defines the fully qualified domain name of the system. This setting is used as a variable, CareOnCloud_CONFIG_FQDN which is found in all forms of messaging used by the application, to build links to the tickets within your system.' =>
            'Inafafanua jina la kikoa lilifuzu la mfumo. Mpangilio huu unatumika kama unaobadilika, CareOnCloud_CONFIG_FQDN inayopatikana katika kila umbizo la ujumbe kwa programu tumizi, kujenga viunganishi kwenye tiketi katika mfumo wako.',
        ...
        'Defines the list of online repositories. Another installations can be used as repository, for example: Key="http://example.com/careoncloud/public.pl?Action=PublicRepository;File=" and Content="Some Name".' =>
            'Inafafanua orodha ya hifadhi za mtandaoni. Usanidi mwingine unaweza kutumika kama hifadhi, kwa mfano: kibonye="http://example.com/careoncloud/public.pl?Action=PublicRepository;File=" na maudhui="Baadhi ya majina".',
        ...
        'Defines the maximal size (in bytes) for file uploads via the browser. Warning: Setting this option to a value which is too low could cause many masks in your CareOnCloud ESM instance to stop working (probably any mask which takes input from the user).' =>
            'Inafafanua upeo wa juu wa ukubwa (katika baiti) kwa ajili ya kupakia faili kwa kivinjari. Onyo: kuwekea chaguo hili thamani ambayo ni ndogo sana inaweza kusababisha barakoa nyingi katika CareOnCloud ESM yako kuacha kufanya kazi (Pengine barakoa inayochukua miingizo kutoka kwa mtumiaji)',
        ...
        'Defines the name of the session key. E.g. Session, SessionID or CareOnCloud ESM.' =>
            'Fafanua jina la funguo wa kipindi.Mfano Kipindi, Kitambulisho cha kipindi au CareOnCloud ESM.',
        ...
        'Enables PGP support. When PGP support is enabled for signing and encrypting mail, it is HIGHLY recommended that the web server runs as the CareOnCloud ESM user. Otherwise, there will be problems with the privileges when accessing .gnupg folder.' =>
            'Inawezesha msaada wa PGP. Wakati msaada wa PGP umewezeshwa kwa ajili ya kuipa na usimbaji fiche barua bebe, inashauriwa kwamba seva ya wavuti kufanya kazi kama mtumiaji wa CareOnCloud ESM. Vinginevyo kutakuwa na matatizo na mapendeleo wakati wa kufikia mpangilio orodha wa .gnupg.',
        ...
        'Filter for debugging ACLs. Note: More ticket attributes can be added in the format <CareOnCloud_TICKET_Attribute> e.g. <CareOnCloud_TICKET_Priority>.' =>
            'Chuja kwa ajili ya ueuaji wa ACL.Angalizo: Sifa za tiketi zaidi vinaweza kuongezwa katika umbizo <CareOnCloud_TICKET_Attribute> mfano <CareOnCloud_TICKET_Priority>.',
        'Filter for debugging Transitions. Note: More filters can be added in the format <CareOnCloud_TICKET_Attribute> e.g. <CareOnCloud_TICKET_Priority>.' =>
            'Chuja kwa ajili ya mipito ya ueuaji.Angalizo: Vichuja zaidi vinaweza kuongezwa katika umbizo <CareOnCloud_TICKET_Attribute> mfano <CareOnCloud_TICKET_Priority>.',
        ...
        'If "LDAP" was selected for Customer::Authmodule, you can check if the user is allowed to authenticate because he is in a posixGroup, e.g. user needs to be in a group xyz to use CareOnCloud ESM. Specify the group, who may access the system.' =>
            'Kama "LDAP" imechaguliwa kwa ajili ya Mteja::Moduli ya uhalalishaji, unaweza kuangalia hapa kama mtumiaji anaruhusiwa kuhalalisha kwasababu yuo kwenye posixGroup, mfano mtumiaji anahitaji kuwa kwenye kikundi xyz kutumia CareOnCloud ESM. Bainisha kikundi, nani anaweza kufikia mfumo.',
        ...
        'If enabled, CareOnCloud ESM will deliver all JavaScript files in minified form.' =>
            'Kama imezeshwa, CareOnCloud ESM itawasilisha mafaili yote ya JavaScript katika umbo dogo.',
        ...
        'Import and export object information.' => 'Leta na hamisha taarifa za kipengee',
        'Import appointments screen.' => '',
        'Import/Export' => 'Leta/Hamisha',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'CareOnCloud ESM Habari',
        ...
        'Sets the prefix to the scripts folder on the server, as configured on the web server. This setting is used as a variable, CareOnCloud_CONFIG_ScriptAlias which is found in all forms of messaging used by the application, to build links to the tickets within the system.' =>
            'Inaweka kiambishi awali kwenye kabrasha la hati katika seva, kama ilivyosanidi katika seva ya tovuti. Mpangilio huu unatumika kama thamani inayobadilika,  CareOnCloud_CONFIG_ScriptAlias ambayo ipo katika miundo yote ya kutuma ujumbe inayotumika programu-tumizi, kujenga viungo kufikia kwenye tiketi katika mfumo.',
        ...
        'Toggles display of CareOnCloud ESM FeatureAddons list in PackageManager.' =>
            'Inageuza onyesho la orodha ya vifaa vya nyongeza ya vipengele vya CareOnCloud ESM  katika msimamizi wa kifurushi.',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Barua pepe yako yenye tiketi namba "<CareOnCloud_TIKETI>" imeunganishwa na "<CareOnCloud_UNGA_KWENYE_TIKETI>".',
        'Your external tools' => '',
        'Your last tickets' => '',
