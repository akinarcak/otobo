...
sub Data {
    ...
    $Self->{Completeness}        = 0.198598798970546;
    ...
    $Self->{Translation} = {
        ...
        'It is sometimes recommended to send this data to the CareOnCloud ESM team in order to get better support.' =>
            'Понякога се препоръчва да изпратите тези данни на екипа на CareOnCloud ESM, за да получите по-добра поддръжка.',
        ...
        'This will allow the system to send additional support data information to the CareOnCloud ESM team.' =>
            'Това ще позволи на системата да изпраща допълнителна информация за данни за поддръжка на екипа на CareOnCloud ESM.',
        'Update' => 'Обновяване',
        ...
        'To enable data sending, please register your system with the CareOnCloud ESM team or update your system registration information (make sure to activate the \'send support data\' option.)' =>
            'За да активирате изпращането на данни, моля, регистрирайте системата си с екипа на CareOnCloud ESM или актуализирайте информацията за регистрация на системата (уверете се, че сте активирали опцията „изпращане на данни за поддръжка“.)',
        ...
        'System registration is a service of CareOnCloud ESM team, which provides a lot of advantages!' =>
            'Регистрацията в системата е услуга на екипа на CareOnCloud ESM, която предоставя много предимства!',
        'Please note that the use of CareOnCloud ESM cloud services requires the system to be registered.' =>
            'Моля, имайте предвид, че използването на облачни услуги на CareOnCloud ESM изисква системата да бъде регистрирана.',
        'Register this system' => 'Регистриране на тази Система',
        ...
        'This CareOnCloud ESM invoker backend module will be called to prepare the data to be sent to the remote system, and to process its response data.' =>
            'Този модул за обратна връзка на CareOnCloud ESM заявки ще бъде извикан, за да подготви данните, които да бъдат изпратени до отдалечената система, и да обработва данните за отговори.',
        ...
        'The data from the invoker of CareOnCloud ESM will be processed by this mapping, to transform it to the kind of data the remote system expects.' =>
            'Данните от заявката на CareOnCloud ESM ще бъдат обработени от това картографиране, за да се превърнат в вид данни, които отдалечената система очаква.',
        ...
        'The response data will be processed by this mapping, to transform it to the kind of data the invoker of CareOnCloud ESM expects.' =>
            'Данните за отговорите ще бъдат обработени от това картографиране, за да бъдат преработени в типа данни, които заявката на CareOnCloud ESM очаква.',
        ...
        'Asynchronous event triggers are handled by the CareOnCloud ESM Scheduler Daemon in background (recommended).' =>
            'Асинхронните събития се обработват от CareOnCloud ESM Scheduler Daemon на заден план (препоръчително).',
        ...
        'This CareOnCloud ESM operation backend module will be called internally to process the request, generating data for the response.' =>
            'Този модул за обратна връзка за операцията CareOnCloud ESM ще бъде наречена вътрешно, за да обработи заявката, генерирайки данни за отговора.',
        ...
        'The request data will be processed by this mapping, to transform it to the kind of data CareOnCloud ESM expects.' =>
            'Данните за заявката ще бъдат обработени от това картографиране, за да се предоставят в вида данни, който CareOnCloud ESM очаква.',
        ...
        'Here you can specify the maximum size (in bytes) of REST messages that CareOnCloud ESM will process.' =>
            'Тук можете да зададете максималния размер (в байтове) на съобщенията, които CareOnCloud ESM ще обработва.',
        ...
        'Here you can specify the maximum size (in bytes) of SOAP messages that CareOnCloud ESM will process.' =>
            'Тук можете да посочите максималния размер (в байтове) на SOAP съобщения, които CareOnCloud ESM ще обработва.',
        'Encoding' => 'Кодиране',
        ...
        'In provider mode, CareOnCloud ESM offers web services which are used by remote systems.' =>
            'В модула за доставчици CareOnCloud ESM предлага уеб услуги, които се използват от отдалечени системи.',
        'In requester mode, CareOnCloud ESM uses web services of remote systems.' =>
            'В режим "рикуестър" CareOnCloud ESM използва уеб услуги на отдалечени системи.',
        ...
        'Import/Export Management' => 'Управление на Импорт/Експорт',
        'Add template' => 'Добавете шаблон',
        'Create a template to import and export object information.' => 'Създайте шаблон за импортиране и експортиране на информация за обект.',
        ...
        'Number' => 'Номер',
        'Format' => 'Формат',
        'Start Import' => 'Стартирайте импортирането',
        'Start Export' => 'Стартирайте експортиране',
        'Delete this template' => 'Изтрийте този шаблон',
        'Step 1 of 5 - Edit common information' => 'Стъпка 1 от 5 – Редактирайте обща информация',
        'Name is required!' => 'Името е задължително!',
        'Object is required!' => 'Обектът е задължителен!',
        'Format is required!' => 'Изисква се формат!',
        'Next' => 'Напред',
        'Step 2 of 5 - Edit object information' => 'Стъпка 2 от 5 - Редактиране на информация за обекта',
        'Back' => 'Назад',
        'Step 3 of 5 - Edit format information' => 'Стъпка 3 от 5 - Редактиране на информация за формата',
        'is required!' => 'изисква се!',
        'Step 4 of 5 - Edit mapping information' => 'Стъпка 4 от 5 - Редактиране на информация за картографиране',
        'No map elements found.' => 'Няма намерени елементи на картата.',
        'Up' => 'Нагоре',
        'Down' => 'Надолу',
        'Add Mapping Element' => 'Добавете елемент за картографиране',
        'Step 5 of 5 - Edit search information' => 'Стъпка 5 от 5 – Редактиране на информацията за търсене',
        'Template Name' => '',
        'Restrict export per search' => 'Ограничете експорта за всяко търсене',
        'Finish' => 'Край',
        'Import information' => 'Импортиране на информация',
        'Source File' => 'Изходен файл',
        'Import summary for %s' => 'Резюме за импортиране за %s',
        'Records' => 'Записи',
        'Success' => 'Успех',
        'Failed' => '',
        'Duplicate names' => 'Дублирани имена',
        'Last processed line number of import file' => 'Номер на последния обработен ред на файла за импортиране',
        'Ok' => 'Да',
        'Do you really want to delete this template item?' => 'Наистина ли искате да изтриете този шаблонен елемент?',
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => '',
        ...
        'We will inform you about our new services and offerings soon.' =>
            '',
        'Can I use CareOnCloud ESM without being registered?' => '',
        'System registration is optional.' => '',
        'You can download and use CareOnCloud ESM without being registered.' => '',
        ...
        'Install Type' => '',
        'Create a new database for CareOnCloud ESM' => '',
        'Use an existing database for CareOnCloud ESM' => '',
        ...
        'Your CareOnCloud ESM Team' => 'Вашият CareOnCloud ESM екип',
        ...
        'To be able to use CareOnCloud ESM you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'За да може да използвате CareOnCloud ESM, Вие трябва да въведете, като superuser root в командния ред (Terminal/Shell) следната команда.',
        'Restart your webserver' => 'Рестарт на web сървъра',
        'After doing so your CareOnCloud ESM is up and running.' => 'След извършването на това, Вашият CareOnCloud ESM е напълно работоспособен.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'Тестова страница на CareOnCloud ESM',
        'Unlock' => 'Отключи',
        'Welcome %s %s' => '',
        'Counter' => 'Брояч',
        ...
        'CareOnCloud ESM as provider' => 'CareOnCloud ESM като доставчик',
        'Operations' => '',
        'CareOnCloud ESM as requester' => 'CareOnCloud ESM като рикуестър',
        'Invokers' => '',
        ...
        'No object backend found!' => 'Не е намерен бекенд на обект!',
        'No format backend found!' => 'Не е намерен бекенд на формат!',
        'Template not found!' => 'Шаблонът не е намерен!',
        'Can\'t insert/update template!' => 'Не може да се вмъкне/актуализира шаблон!',
        'Needed TemplateID!' => 'Необходим ID на шаблон!',
        'Error occurred. Import impossible! See Syslog for details.' => 'Възникна грешка. Вносът е невъзможен! Вижте Syslog за подробности.',
        'Error occurred. Export impossible! See Syslog for details.' => 'Възникна грешка. Невъзможен експорт! Вижте Syslog за подробности.',
        'Template List' => 'Списък с шаблони',
        'number' => 'номер',
        'number bigger than zero' => 'число по-голямо от нула',
        'integer' => 'цяло число',
        'integer bigger than zero' => 'цяло число, по-голямо от нула',
        'Element required, please insert data' => 'Необходим е елемент, моля, въведете данни',
        'Invalid data, please insert a valid %s' => 'Невалидни данни, моля, въведете валиден %s',
        'Format not found!' => 'Форматът не е намерен!',
        ...
        'Install CareOnCloud ESM' => 'Инсталирай CareOnCloud ESM',
        'Intro' => 'Въведение',
        ...
        'CareOnCloud ESM Daemon is not running.' => 'CareOnCloud ESM Daemon не се изпълнява.',
        ...
        'Column Separator' => 'Разделител на колони',
        'Tabulator (TAB)' => 'Разделител (TAB)',
        'Semicolon (;)' => 'Точка и запетая (;)',
        'Colon (:)' => 'Двоеточие (:)',
        'Dot (.)' => 'Точка (.)',
        'Comma (,)' => 'Запетая (,)',
        'Charset' => 'Кодировка',
        'Include Column Headers' => 'Включете заглавки на колони',
        'Column' => 'Колона',
...
' => '',
        ...
        'Import and export object information.' => 'Импортиране и експортиране на информация за обекта.',
        ...
        'OIDC Profiles' => '',
        'CareOnCloud ESM News' => 'Новини за CareOnCloud ESM',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Вашето писмо с номер на билета "<CareOnCloud_TICKET>" е изравнено с "<CareOnCloud_MERGE_TO_TICKET>".',
        'Your external tools' => '',
        'Your last tickets' => '',
