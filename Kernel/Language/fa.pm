...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'This package is verified by CareOnCloud ESMverify (tm)' => 'این بسته توسط CareOnCloud ESMverify تایید (TM)',
        'Uninstall' => 'حذف بسته',
