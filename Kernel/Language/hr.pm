...
sub Data {
    ...
    $Self->{Completeness}        = 0.192021732913926;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this CareOnCloud ESM system.' =>
            'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj CareOnCloud ESM sustav',
        'Generated password' => '',
        'Repeat Password' => '',
        ...
        'After doing so your CareOnCloud ESM is up and running.' => 'Nakon ovoga Vaš CareOnCloud ESM je uključen i radi.',
        ...
        # Template: Test
        'CareOnCloud ESM Test Page' => 'CareOnCloud ESM test stranica',
        'Unlock' => 'Otključano',
        'Welcome %s %s' => '',
        'Counter' => 'Brojač',
...
' => '',
        ...
        'Your email with ticket number "<CareOnCloud_TICKET>" is merged to "<CareOnCloud_MERGE_TO_TICKET>".' =>
            'Vaša poruka E-pošte sa brojem kartice "<CareOnCloud_TICKET>" je objedinjena sa karticom "<CareOnCloud_MERGE_TO_TICKET>"!',
        'Your external tools' => '',
        'Your last tickets' => '',
