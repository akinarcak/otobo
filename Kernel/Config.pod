...
Most SysConfig settings are loaded from F<*.pm> files in the directory F<Kernel/Config/Files/>.
The '<CareOnCloud_CONFIG_key>' macros are evaluated in the loaded strings.
...
NOTE: This method is currently not used in core CareOnCloud ESM.
