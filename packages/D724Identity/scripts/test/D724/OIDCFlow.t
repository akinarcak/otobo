...
$H->ConfigSettingChange(Key=>'D724::Identity::Enabled',Value=>1);$H->ConfigSettingChange(Key=>'D724::TenantGuard::Enabled',Value=>1);$H->ConfigSettingChange(Key=>'D724::TenantGuard::AllowPlatformAdmin',Value=>1);
my$I=$Kernel::OM->Get('Kernel::System::D724::Identity');my$F=$Kernel::OM->Get('Kernel::System::D724::OIDCFlow');my$D=$Kernel::OM->Get('Kernel::System::D724::TenantDirectory');my$DB=$Kernel::OM->Get('Kernel::System::DB');
