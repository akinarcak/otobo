...
# --
package Kernel::System::D724::SearchPolicy;
...
our @ObjectDependencies = (
    'Kernel::Config', 'Kernel::System::D724::TenantGuard',
    'Kernel::System::D724::TicketPolicy', 'Kernel::System::Log',
);
...
sub ContextCreate {
    ...
    return $Self->_Deny('SEARCH_POLICY_DISABLED')
        if !$Kernel::OM->Get('Kernel::Config')->Get('D724::SearchPolicy::Enabled');
    my $Context = $Kernel::OM->Get('Kernel::System::D724::TicketPolicy')->ContextResolve(%Param);
...
sub RequestFilterApply {
    ...
    my %Configured = map { $_ => 1 } @{ $Kernel::OM->Get('Kernel::Config')->Get('D724::SearchPolicy::TenantSafeIndexes') // [] };
...
sub _Deny {
    ...
    $Kernel::OM->Get('Kernel::System::Log')->Log(
        Priority => 'error', Message => "D724_SEARCH_POLICY_DENY Reason=$Reason",
    );
