...
package Kernel::System::Console::Command::Admin::CareOnCloud::TenantBootstrap;
...
our @ObjectDependencies = ('Kernel::System::CareOnCloud::TenantDirectory');
...
sub Run {
    my ($Self) = @_;
    my $Result = $Kernel::OM->Get('Kernel::System::CareOnCloud::TenantDirectory')->Bootstrap(
