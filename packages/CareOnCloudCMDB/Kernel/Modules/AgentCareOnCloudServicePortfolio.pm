...
# --
package Kernel::Modules::AgentCareOnCloudServicePortfolio;
...
sub Run {
    ...
    my $CMDB = $Kernel::OM->Get('Kernel::System::CareOnCloud::CMDB');
    ...
    $Output .= $Layout->Output( TemplateFile => 'AgentCareOnCloudServicePortfolio', Data => { TenantID => $TenantID, ServiceID => $ServiceID // q{}, ServiceCount => scalar keys %Services, InstanceCount => scalar grep { $_->{ServiceInstanceID} } @{ $Portfolio->{Data} } } );
