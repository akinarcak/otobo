...
$Helper->ConfigSettingChange( Key => 'D724::API::MetricsEnabled', Value => 1 );
my $Metric = $Kernel::OM->Get('Kernel::System::D724::APIMetric');
...
my $Route = 'tickets';
$DB->Prepare(
    SQL => 'SELECT request_count, duration_sum_ms, duration_max_ms FROM d724_api_metric WHERE tenant_id = ? AND route_key = ? AND status_code = 200',
