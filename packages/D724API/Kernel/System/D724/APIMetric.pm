...
# --
package Kernel::System::D724::APIMetric;
...
sub Record {
    ...
    return { Success => 0, Error => 'METRICS_DISABLED' }
        if !$Kernel::OM->Get('Kernel::Config')->Get('D724::API::MetricsEnabled');
