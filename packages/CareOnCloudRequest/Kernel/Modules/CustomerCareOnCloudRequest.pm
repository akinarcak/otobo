...
package Kernel::Modules::CustomerCareOnCloudRequest;
...
sub Run {
    ...
    if ( ( $Self->{Subaction} // q{} ) eq 'Submit' ) {
        ...
        my $Item = $Kernel::OM->Get('Kernel::System::CareOnCloud::CatalogPortal')->ItemGet(
            %Context,
    ...
    return join q{},
        ...
        $Layout->Output( TemplateFile => 'CustomerCareOnCloudRequest', Data => \%Param ),
