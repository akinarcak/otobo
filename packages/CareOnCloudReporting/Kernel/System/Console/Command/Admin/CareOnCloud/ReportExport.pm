...
# --
package Kernel::System::Console::Command::Admin::CareOnCloud::ReportExport;
use v5.24;
use strict;
use warnings;
...
our $VERSION = '0.3.1';
our @ObjectDependencies = ('Kernel::System::CareOnCloud::Reporting');
...
sub Run {
    my ($Self) = @_;
    my $Result = $Kernel::OM->Get('Kernel::System::CareOnCloud::Reporting')->Export(
