...
my $Module = File::Spec->catfile( $Root, 'Kernel', 'System', 'CareOnCloud', 'SCIM.pm' );
...
unlike( $Source, qr/careoncloud_user_id|CareOnCloudUserID/, 'legacy upstream-branded user link is absent from runtime code' );
...
my $Transport = File::Spec->catfile( $Root, 'Kernel', 'Modules', 'PublicCareOnCloudSCIM.pm' );
