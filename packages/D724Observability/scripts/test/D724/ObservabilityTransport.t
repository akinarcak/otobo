...
use Kernel::Modules::PublicD724Metrics;
my $Module=$INC{'Kernel/Modules/PublicD724Metrics.pm'};
...
unlike($Source,qr/X-D724-Metrics-Token/,'transport does not use a non-standard secret header');
is(length(sha256_hex('test-token')),64,'configured token representation is a SHA-256 digest');
my $Transport=Kernel::Modules::PublicD724Metrics->new();
