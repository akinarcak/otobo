...
my $Command = $Kernel::OM->Get('Kernel::System::Console::Command::Admin::CareOnCloud::TenantCacheStatus');
...
$Helper->ConfigSettingChange( Key => 'CareOnCloud::TenantCache::MaximumTTLSeconds', Value => 0 );
