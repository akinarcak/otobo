...
# --
package Kernel::System::Console::Command::Admin::CareOnCloud::TenantCacheStatus;
...
sub StatusData {
    ...
    my $Enabled = $Config->Get('CareOnCloud::TenantCache::Enabled') ? 1 : 0;
    my $Maximum = $Config->Get('CareOnCloud::TenantCache::MaximumTTLSeconds') // 86400;
    ...
    return {
        Success => $Success ? 1 : 0,
        Package => 'CareOnCloudTenantGuard',
