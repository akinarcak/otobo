...
my $FoundationObject = $Kernel::OM->Get('Kernel::System::CareOnCloud::Foundation');
...
is( $Manifest->{Package}, 'CareOnCloudFoundation', 'package name is stable' );
...
{
    local $ConfigObject->{'CareOnCloud::Foundation::Enabled'} = 0;
