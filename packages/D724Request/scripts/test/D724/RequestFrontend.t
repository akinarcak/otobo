...
my $CustomerHTML = $Layout->Output(
    ...
    Data => { Request => {
        ...
        Commitment => { Status => 'running', WarningTime => '2026-07-27 11:00:00', DueTime => '2026-07-27 13:00:00' },
    } },
);
...
$Layout->Block( Name => 'Commitment', Data => { Status => 'warning', WarningTime => '2026-07-27 11:00:00', DueTime => '2026-07-27 13:00:00' } );
