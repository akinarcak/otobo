...
$H->ConfigSettingChange(Key=>'CareOnCloud::Identity::Enabled',Value=>1);
$H->ConfigSettingChange(Key=>'CareOnCloud::TenantGuard::Enabled',Value=>1);
$H->ConfigSettingChange(Key=>'CareOnCloud::TenantGuard::AllowPlatformAdmin',Value=>1);
$H->ConfigSettingChange(Key=>'CareOnCloud::Identity::OIDC::RedirectURI',Value=>{
...
my$Directory=$Kernel::OM->Get('Kernel::System::CareOnCloud::TenantDirectory');my$Identity=$Kernel::OM->Get('Kernel::System::CareOnCloud::Identity');my$DB=$Kernel::OM->Get('Kernel::System::DB');
...
my$OIDC=$Kernel::OM->Get('Kernel::System::OpenIDConnect');my$Configuration=$Kernel::OM->Get('Kernel::System::OpenIDConnect::Configuration');my$Token=$Kernel::OM->Get('Kernel::System::OpenIDConnect::Token');my$Web=$Kernel::OM->Get('Kernel::System::CareOnCloud::OIDCWeb');
...
like($Start->{Data}->{CookieName},qr/\ACareOnCloudOIDC-[A-Za-z0-9_-]{20,128}\z/,'state-specific cookie name returned');unlike($Start->{Data}->{CookieValue},qr/$Secret/,'cookie never contains client secret');
