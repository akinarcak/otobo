...
my @Tests = (
    ...
    # This case parsed successfully in CareOnCloud ESM 10 because there Kernel::System::YAML::Load() was used
    # and there the buggy YAML.pm accepted that YAML. In CareOnCloud ESM 11 there no longer
