...
# from /opt/careoncloud. This will also regenrated the scripts/test/sample/SMIME/smime_test.json
...
my @Certificates = (
    ...
    },
    {
        ...
        CertificateHash       => $TestConfig->{2}->{Hash},
    ...
    push @TestVariations, {
        ...
        ArticleData => {
            ...
            EmailSecurity => {
                Backend     => 'SMIME',
                Method      => 'Detached',
                EncryptKeys => [ $TestConfig->{1}->{Hash} . '.0', $AxelCertHash . '.0' ],
            },
        },
        VerifySignature  => 0,
        VerifyDecryption => 1,
    ...
    push @TestVariations, {
        ...
        ArticleData => {
            ...
            EmailSecurity => {
                Backend     => 'SMIME',
                Method      => 'Detached',
                EncryptKeys => [ $TestConfig->{1}->{Hash} . '.0' ],
            },
        },
        VerifySignature  => 0,
        VerifyDecryption => 1,
