...
sub PrepareTestSysConfig {
    ...
    $ConfigObject->Set(
        ...
        Value => 'Kernel::System::CustomerAuth::OpenIDConnect'
    );
    $ConfigObject->Set(
        Key   => 'Customer::AuthModule::OpenIDConnect::AuthRequest',
        Value => {
            ResponseType    => ['code'],
    ...
    $ConfigObject->Set(
        Key   => 'Customer::AuthModule::OpenIDConnect::Config',
        Value => $OpenIDConfig
    );

    $ConfigObject->Set(
        Key   => 'Customer::AuthModule::OpenIDConnect::UID',
        Value => $Sub
    );
